...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Is(e,t,n){return new Ta({name:`SphericalGaussianBlur`,defines:{SAMPLES:xs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:zs(),fragmentShader:`
...
`,Bu=`// Fullscreen quad: the PlaneGeometry(2,2) already spans clip space, so no
...
`,Vu=null;function Hu(){if(!Vu){let e=new Fn,t=new jo(-1,1,1,-1,0,1),n=new oi(new ma(2,2));n.frustumCulled=!1,e.add(n),Vu={scene:e,camera:t,mesh:n}}return Vu}var Uu=class{material;constructor(e,t,n={}){this.material=new Ea({glslVersion:Ke,vertexShader:Bu,fragmentShader:e,uniforms:t,defines:n.defines??{},depthTest:!1,depthWrite:!1,blending:0})}get uniforms(){return this.material.uniforms}render(e,t){let n=Hu();n.mesh.material=this.material,e.setRenderTarget(t),e.render(n.scene,n.camera)}dispose(){this.material.dispose()}};function Wu(e,t=1,n={}){let i=n.linear||n.mipmaps,a=!!n.mipmaps;return new Xt(e,n.height??e,{count:t,type:v,format:D,minFilter:a?d:i?l:o,magFilter:i?l:o,wrapS:r,wrapT:r,depthBuffer:!1,stencilBuffer:!1,generateMipmaps:a})}var Gu=new WeakSet;function Ku(e){let t=e.extensions.has(`OES_texture_float_linear`);return Gu.has(e)||(Gu.add(e),console.info(t?`[ocean] OES_texture_float_linear: displacement/foam textures use LinearFilter`:`[ocean] OES_texture_float_linear missing: displacement/foam textures fall back to NearestFilter`)),t}function qu(e,t,n){if(e.length!==t*n*4)throw Error(`makeFloatDataTexture: expected ${t*n*4} floats, got ${e.length}`);let i=new bi(e,t,n,D,v);return i.minFilter=o,i.magFilter=o,i.wrapS=r,i.wrapT=r,i.generateMipmaps=!1,i.flipY=!1,i.needsUpdate=!0,i}var Ju=class{N;size;targets;pass;constructor(e,t){this.N=e,this.size=t,this.targets=Wu(e,4),this.pass=new Uu(zu,{uH0:{value:null},uN:{value:e},uL:{value:t},uT:{value:0},uGravity:{value:9.81}})}render(e,t,n,r){let i=this.pass.uniforms;i.uH0.value=t,i.uT.value=n*r.animationSpeed,i.uGravity.value=r.gravity,this.pass.render(e,this.targets)}dispose(){this.pass.dispose(),this.targets.dispose()}};function Yu(e){return e>0&&!(e&e-1)}function Xu(e){let t=0;for(;1<<t<e;)t++;return t}function Zu(e,t){let n=0;for(let r=0;r<t;r++)n=n<<1|e&1,e>>=1;return n}function Qu(e){if(!Yu(e))throw Error(`butterflyTable: N=${e} is not a power of two`);let t=Xu(e),n=new Float32Array(t*e*4);for(let r=0;r<t;r++){let i=1<<r,a=i<<1;for(let o=0;o<e;o++){let s=o%a,c=s<i,l=c?s:s-i,u=c?o:o-i,d=c?o+i:o;r===0&&(u=Zu(u,t),d=Zu(d,t));let f=-2*Math.PI*l/a,p=c?1:-1,m=(r*e+o)*4;n[m]=u,n[m+1]=d,n[m+2]=p*Math.cos(f),n[m+3]=p*Math.sin(f)}}return{N:e,stages:t,data:n}}var $u=`// One radix-2 butterfly stage over four RGBA textures at once (eight complex
...
`,ed=class{N;stages;butterfly;pingPong;pass;constructor(e,t={}){this.N=e;let n=Qu(e);this.stages=n.stages,this.butterfly=qu(n.data,e,n.stages),this.pingPong=[Wu(e,4),Wu(e,4)];let r={};t.inverse!==!1&&(r.INVERSE=1),this.pass=new Uu($u,{uIn0:{value:null},uIn1:{value:null},uIn2:{value:null},uIn3:{value:null},uButterfly:{value:this.butterfly},uStage:{value:0},uVertical:{value:!1}},{defines:r})}render(e,t){let n=t instanceof Xt?t.textures:t;if(n.length!==4)throw Error(`FftPass.render: expected 4 input textures, got ${n.length}`);let r=this.pass.uniforms,i=0;for(let t=0;t<2*this.stages;t++){let a=this.pingPong[i];r.uIn0.value=n[0],r.uIn1.value=n[1],r.uIn2.value=n[2],r.uIn3.value=n[3],r.uStage.value=t%this.stages,r.uVertical.value=t>=this.stages,this.pass.render(e,a),n=a.textures,i^=1}return this.pingPong[i^1]}dispose(){this.pass.dispose(),this.butterfly.dispose(),this.pingPong[0].dispose(),this.pingPong[1].dispose()}},td=`// Persistent foam energy field (spec §1.5, heavy-sea rework §1.16).
...
`,nd=class{N;size;pingPong;current=0;pass;needsClear=!0;windDrift;phase=0;constructor(e,t,n=!1,r={}){this.N=e,this.size=t,this.pingPong=[Wu(e,1,{linear:n}),Wu(e,1,{linear:n})],this.windDrift=r.windDrift??.03,this.pass=new Uu(td,{uPrev:{value:null},uJacobian:{value:null},uDerivatives:{value:null},uN:{value:e},uDt:{value:0},uDecayTime:{value:.5},uThreshold:{value:.6},uCrestStrength:{value:2.5},uWindwardStrength:{value:1.5},uWindDir:{value:new W(1,0)},uCell:{value:t/e},uSlide:{value:r.slide??.9},uWindDrift:{value:0},uTroughBoost:{value:r.troughBoost??1.5},uBreakup:{value:r.breakup??0},uPhase:{value:0}})}get texture(){return this.target.texture}get target(){return this.pingPong[this.current]}reset(){this.needsClear=!0}render(e,t,n){if(this.needsClear){for(let t of this.pingPong)e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1);this.needsClear=!1}let r=this.pingPong[this.current],i=this.pingPong[this.current^1],a=this.pass.uniforms;a.uPrev.value=r.texture,a.uJacobian.value=n.jacobian,a.uDerivatives.value=n.derivatives,a.uDt.value=n.dt,a.uDecayTime.value=t.decayTime,a.uThreshold.value=t.threshold,a.uCrestStrength.value=t.crestStrength,a.uWindwardStrength.value=t.windwardStrength,a.uWindDir.value.set(n.windDir[0],n.windDir[1]),a.uWindDrift.value=this.windDrift*(n.windSpeed??0),this.phase=(this.phase+n.dt*.6)%1024,a.uPhase.value=this.phase,this.pass.render(e,i),this.current^=1}dispose(){this.pass.dispose(),this.pingPong[0].dispose(),this.pingPong[1].dispose()}};function rd(e,t,n,r,i,a,o=0){let s=new Float32Array(i*a*4);return e.readRenderTargetPixels(t,n,r,i,a,s,void 0,o),s}var id=class{renderer;gl;slots=new Map;constructor(e){this.renderer=e,this.gl=e.getContext()}issue(e,t,n,r,i,a,o=0){let s=this.gl,c=this.slots.get(e);c||(c={pbo:s.createBuffer(),sync:null,data:new Float32Array,w:0,h:0},this.slots.set(e,c)),c.sync&&(s.deleteSync(c.sync),c.sync=null);let l=i*a*4*4,u=this.renderer.getRenderTarget();this.renderer.setRenderTarget(t),t.textures.length>1&&s.readBuffer(s.COLOR_ATTACHMENT0+o),s.bindBuffer(s.PIXEL_PACK_BUFFER,c.pbo),s.bufferData(s.PIXEL_PACK_BUFFER,l,s.STREAM_READ),(c.w!==i||c.h!==a)&&(c.data=new Float32Array(i*a*4),c.w=i,c.h=a),s.readPixels(n,r,i,a,s.RGBA,s.FLOAT,0),s.bindBuffer(s.PIXEL_PACK_BUFFER,null),c.sync=s.fenceSync(s.SYNC_GPU_COMMANDS_COMPLETE,0),s.flush(),this.renderer.setRenderTarget(u)}consume(e){let t=this.slots.get(e);if(!t||!t.sync)return null;let n=this.gl;return n.clientWaitSync(t.sync,n.SYNC_FLUSH_COMMANDS_BIT,0),n.bindBuffer(n.PIXEL_PACK_BUFFER,t.pbo),n.getBufferSubData(n.PIXEL_PACK_BUFFER,0,t.data),n.bindBuffer(n.PIXEL_PACK_BUFFER,null),n.deleteSync(t.sync),t.sync=null,t.data}pending(e){return!!this.slots.get(e)?.sync}reset(){this.slots.clear()}dispose(){let e=this.gl;for(let t of this.slots.values())t.sync&&e.deleteSync(t.sync),e.deleteBuffer(t.pbo);this.slots.clear()}};function ad(e){let t=e>>>0;return()=>{t=t+2654435769>>>0;let e=t;return e=Math.imul(e^e>>>16,569420461),e=Math.imul(e^e>>>15,1935289751),e=(e^e>>>15)>>>0,e/4294967296}}function od(e){let t=1-e(),n=e(),r=Math.sqrt(-2*Math.log(t)),i=2*Math.PI*n;return[r*Math.cos(i),r*Math.sin(i)]}var sd=9.81;function cd(e,t=sd){return Math.sqrt(t*e)}function ld(e,t){if(e<=0)return 0;let{omegaPeak:n,gamma:r,sharpness:i,alpha:a,g:o}=t,s=e<=n?.07:.09,c=e-n,l=Math.exp(-(c*c)/(2*s*s*n*n)),u=n/e;return a*o*o/e**5*Math.exp(-1.25*u**4)*r**+(l*i)}function ud(e,t=sd){return .21*e*e/t}var dd=.06,fd=4;function pd(e){let t=ud(e.windSpeed,e.gravity),n=dd*e.peakWavelength;if(t<=0)return 0;let r=(t**-4+n**-4)**(-1/fd);return e.amplitude*r}var md=2048;function hd(e){let t=Math.log(e.omegaPeak/50),n=(Math.log(e.omegaPeak*50)-t)/md,r=0;for(let i=0;i<=md;i++){let a=Math.exp(t+i*n),o=ld(a,e)*a;r+=i===0||i===md?o/2:o}return r*n}var gd=2;function _d(e){let t=pd(e);if(t<=0)return 0;let n=hd({omegaPeak:cd(2*Math.PI/e.peakWavelength,e.gravity),gamma:e.jonswapGamma,sharpness:e.spectralSharpness,alpha:1,g:e.gravity});if(n<=0)return 0;let r=t/4;return r*r/gd/n}function vd(e,t){return Math.trunc(e)+Math.round(t*64)*40503>>>0}var yd=`// Initial spectrum h0(k) — GPU port of core/spectrum.ts \`phi()\` and
...
`,bd=1e30;function xd(e,t,n){let r=ad(vd(e,n)),i=new Float32Array(t*t*4);for(let e=0;e<t*t;e++){let[t,n]=od(r);i[e*4]=t,i[e*4+1]=n}return i}var Sd=class{N;layout;target;pass;gauss=null;gaussSeed=NaN;constructor(e,t){this.N=e,this.layout=t,this.target=Wu(e,1),this.pass=new Uu(yd,{uGauss:{value:null},uN:{value:e},uL:{value:t.size},uKMin:{value:t.kMin},uKMax:{value:Number.isFinite(t.kMax)?t.kMax:bd},uKMinWidth:{value:t.kMinWidth},uKMaxWidth:{value:Number.isFinite(t.kMax)?t.kMaxWidth:0},uAlpha:{value:0},uWindSpeed:{value:1},uWindDirection:{value:0},uGravity:{value:9.81},uGamma:{value:3.3},uPeakWavelength:{value:70},uSharpness:{value:1},uStandingWaveRatio:{value:0}})}get texture(){return this.target.texture}render(e,t){(this.gauss===null||this.gaussSeed!==t.seed)&&(this.gauss?.dispose(),this.gauss=qu(xd(t.seed,this.N,this.layout.size),this.N,this.N),this.gaussSeed=t.seed);let n=this.pass.uniforms;n.uGauss.value=this.gauss,n.uAlpha.value=_d(t),n.uWindSpeed.value=t.windSpeed,n.uWindDirection.value=t.windDirection,n.uGravity.value=t.gravity,n.uGamma.value=t.jonswapGamma,n.uPeakWavelength.value=t.peakWavelength,n.uSharpness.value=t.spectralSharpness,n.uStandingWaveRatio.value=t.standingWaveRatio,this.pass.render(e,this.target)}dispose(){this.pass.dispose(),this.target.dispose(),this.gauss?.dispose()}},Cd=`// Unpack — GPU twin of core/oceanCpu.ts \`channelToField()\` + \`simulate()\`.
...
`,wd=class{N;targets;pass;constructor(e,t=!1){this.N=e,this.targets=Wu(e,3,{mipmaps:t}),this.pass=new Uu(Cd,{uIn0:{value:null},uIn1:{value:null},uIn2:{value:null},uIn3:{value:null},uN:{value:e},uLambda:{value:1}})}get displacement(){return this.targets.textures[0]}get derivatives(){return this.targets.textures[1]}get jacobian(){return this.targets.textures[2]}render(e,t,n){let r=this.pass.uniforms,i=t.textures;r.uIn0.value=i[0],r.uIn1.value=i[1],r.uIn2.value=i[2],r.uIn3.value=i[3],r.uLambda.value=n,this.pass.render(e,this.targets)}dispose(){this.pass.dispose(),this.targets.dispose()}},Td=class{renderer;N;layout;spectrum;evolve;fft;unpack;foamPass;ownsFft;spectrumDirty=!0;foamInputs={jacobian:null,derivatives:null,dt:0,windDir:[1,0],windSpeed:0};constructor(e,t,n,r={}){if(this.renderer=e,this.N=t,this.layout=n,this.spectrum=new Sd(t,n),this.evolve=new Ju(t,n.size),r.fft&&r.fft.N!==t)throw Error(`Cascade: shared FftPass is N=${r.fft.N}, cascade is N=${t}`);this.fft=r.fft??new ed(t,{inverse:!0}),this.ownsFft=!r.fft;let i=Ku(e);this.unpack=new wd(t,i),this.foamPass=r.foam?new nd(t,n.size,i,{breakup:.45}):null}get size(){return this.layout.size}get displacement(){return this.unpack.displacement}get derivatives(){return this.unpack.derivatives}get jacobian(){return this.unpack.jacobian}get foam(){return this.foamPass?.texture??null}readDisplacementBlock(e,t,n,r){let i=this.renderer.getRenderTarget(),a=rd(this.renderer,this.unpack.targets,e,t,n,r,0);return this.renderer.setRenderTarget(i),a}invalidateSpectrum(){this.spectrumDirty=!0}update(e,t,n=Nu){n.begin(`spectrum`),this.spectrumDirty&&=(this.spectrum.render(this.renderer,t),!1),this.evolve.render(this.renderer,this.spectrum.texture,e,t),n.end(),n.begin(`fft`);let r=this.fft.render(this.renderer,this.evolve.targets);n.end(),n.begin(`unpack`),this.unpack.render(this.renderer,r,t.choppiness),n.end()}updateFoam(e,t,n,r=0,i=Nu){if(!this.foamPass)return;let a=this.foamInputs;a.jacobian=this.jacobian,a.derivatives=this.derivatives,a.dt=e,a.windDir[0]=Math.cos(n),a.windDir[1]=Math.sin(n),a.windSpeed=r,i.begin(`unpack`),this.foamPass.render(this.renderer,t,a),i.end()}dispose(){this.spectrum.dispose(),this.evolve.dispose(),this.ownsFft&&this.fft.dispose(),this.unpack.dispose(),this.foamPass?.dispose()}},Ed=2,Dd=class{renderer;cascades=[];timer=Nu;ffts=new Map;reader;params;constructor(e,t){this.renderer=e,this.params=Ou(t),this.reader=new id(e),this.build()}get N(){return Du(this.params.quality).N}getParams(){return Ou(this.params)}setParams(e){let t=this.params;if(this.params=Ou(e),e.quality!==t.quality||e.maxScale!==t.maxScale){this.build();return}if(JSON.stringify(e.waves)!==JSON.stringify(t.waves))for(let e of this.cascades)e.invalidateSpectrum();if(!e.foam.enabled&&t.foam.enabled)for(let e of this.cascades)e.foamPass?.reset()}update(e,t){let{waves:n,foam:r}=this.params,i=this.timer;for(let a of this.cascades)a.update(e,n,i),r.enabled&&a.updateFoam(t,r,n.windDirection,n.windSpeed,i)}readDisplacementBlock(e,t,n,r,i){let a=this.cascades[e];if(!a)throw RangeError(`readDisplacementBlock: no cascade ${e}`);return a.readDisplacementBlock(t,n,r,i)}issueDisplacementBlock(e,t,n,r,i,a){let o=this.cascades[t];if(!o)throw RangeError(`issueDisplacementBlock: no cascade ${t}`);this.reader.issue(e,o.unpack.targets,n,r,i,a,0)}consumeDisplacementBlock(e){return this.reader.consume(e)}contextRestored(){this.reader.reset(),this.cascades=[],this.ffts.clear(),this.build()}dispose(){this.disposeCascades(),this.reader.dispose()}disposeCascades(){for(let e of this.cascades)e.dispose();this.cascades=[];for(let e of this.ffts.values())e.dispose();this.ffts.clear()}build(){this.disposeCascades();let e=Du(this.params.quality),t=Lu(this.params.maxScale,this.params.quality);this.cascades=t.map((t,n)=>{let r=t.N,i=this.ffts.get(r);return i||(i=new ed(r,{inverse:!0}),this.ffts.set(r,i)),new Td(this.renderer,r,t,{foam:e.foam&&n<Ed,fft:i})})}};function Od(e,t,n){if(e%4!=0||e<4)throw Error(`clipmap: segments must be a multiple of 4`);let r=[],i=[],a=[],o=[],s=e/2,c=e/4,l=e-e/4;for(let u=0;u<=t;u++){let d=n*2**u,f=r.length/3,p=u<t;for(let t=0;t<=e;t++)for(let n=0;n<=e;n++){r.push((n-s)*d,0,(t-s)*d);let o=0,c=0,l=n===0||n===e,f=t===0||t===e,m=l||f;p&&(l&&t%2==1?c=d:f&&n%2==1&&(o=d)),i.push(p&&m?u+1:u),a.push(o,c)}for(let t=0;t<e;t++)for(let n=0;n<e;n++){if(u>0&&n>=c&&n<l&&t>=c&&t<l)continue;let r=f+t*(e+1)+n,i=r+1,a=r+e+1,s=a+1;o.push(r,a,i,i,a,s)}}let u=new Nr;u.setAttribute(`position`,new X(r,3)),u.setAttribute(`ring`,new X(i,1)),u.setAttribute(`seam`,new X(a,2)),u.setIndex(o);let d=s*n*2**t;return u.boundingSphere=new Tr(new G(0,0,0),d*2),u}function kd(e,t,n){return[Math.floor(e/n)*n,Math.floor(t/n)*n]}var Ad=class e{renderer;target;clearColor=new Y(0,0,0);size=new W;prevClear=new Y;linearOut=[];constructor(t){this.renderer=t,this.target=e.makeTarget(1,1)}static makeTarget(e,t){let n=new aa(e,t,v);n.format=O,n.minFilter=o,n.magFilter=o,n.name=`SceneDepth`;let r=new Xt(e,t,{type:y,format:D,minFilter:l,magFilter:l,generateMipmaps:!1,depthBuffer:!0,stencilBuffer:!1,depthTexture:n});return r.texture.name=`SceneColor`,r}get color(){return this.target.texture}get depth(){return this.target.depthTexture}get width(){return this.target.width}get height(){return this.target.height}render(t,n){let r=this.renderer;r.getDrawingBufferSize(this.size);let i=Math.max(1,Math.floor(this.size.x)),a=Math.max(1,Math.floor(this.size.y));(this.target.width!==i||this.target.height!==a)&&(this.target.dispose(),this.target=e.makeTarget(i,a)),this.linearOut.length=0,t.traverse(e=>{e.userData.castsWaterDepth&&e.traverse(e=>{e.layers.enable(1);let t=e.material;for(let e of Array.isArray(t)?t:t?[t]:[]){let t=e.uniforms?.uLinearOut;t&&this.linearOut.push(t)}})});let o=r.getRenderTarget(),s=n.layers.mask,c=r.autoClear;r.getClearColor(this.prevClear);let l=r.getClearAlpha();for(let e of this.linearOut)e.value=1;n.layers.set(1),r.setRenderTarget(this.target),r.setClearColor(this.clearColor,0),r.autoClear=!0,r.render(t,n);for(let e of this.linearOut)e.value=0;r.setClearColor(this.prevClear,l),r.autoClear=c,r.setRenderTarget(o),n.layers.mask=s}dispose(){this.target.dispose()}},jd=`// Shared helpers, spliced into the water (both stages), sky, terrain,
...
`,Md={sunTintHigh:[1,.96,.9],sunTintLow:[1,.42,.12],sunWarmEl:.35,sunFadeEl:-.18,dayElLo:-.3,dayElHi:.15,zenithDay:[.04,.13,.32],horizonDay:[.17,.23,.31],zenithNight:[.022,.03,.05],horizonNight:[.04,.05,.075],moonRiseEl:-.35,moonFullEl:-.6,moonTint:[.62,.7,.9]},Nd=e=>Number.isInteger(e)?e.toFixed(1):String(e),Pd=e=>typeof e==`number`?Nd(e):`vec3(${e.map(Nd).join(`, `)})`,Fd=e=>e.replace(/([a-z])([A-Z])/g,`$1_$2`).toUpperCase();function Id(){return Object.keys(Md).map(e=>`#define SKY_${Fd(e)} ${Pd(Md[e])}`).join(`
`)+`
`}var Ld=`//#include common`,Rd=Id()+jd;function zd(e){if(!e.includes(Ld))throw Error("withCommon: shader has no `//#include common` marker");return e.replace(Ld,Rd)}var Bd=`precision highp float;
...
`,Hd=128,Ud=2.75,Wd=new Y(...Md.zenithDay),Gd=new Y(...Md.horizonDay),Kd=new Y(...Md.zenithNight),qd=new Y(...Md.horizonNight),Jd=new Y(.02,.05,.07),Yd=new Y(...Md.sunTintHigh),Xd=new Y(...Md.sunTintLow);function Zd(e,t=new G){let n=Math.sin((e-6)/12*Math.PI),r=Math.sqrt(Math.max(0,1-n*n));return t.set(r*Math.sin(Ud),n,r*Math.cos(Ud)).normalize()}var Qd=Md.moonRiseEl,$d=Md.moonFullEl;function ef(e,t=new G){let n=.3*Math.min(1,Math.max(0,(e.y-Qd)/(-1-Qd))),r=Math.sqrt(Math.max(0,1-n*n));return t.set(r*Math.sin(Ud),n,r*Math.cos(Ud)).normalize()}function tf(e){let t=Math.min(1,Math.max(0,(e.y-Qd)/($d-Qd)));return t*t*(3-2*t)}function nf(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}function rf(e,t,n,r,i){return new Ea({glslVersion:Ke,vertexShader:Bd,fragmentShader:zd(Vd),defines:e?{TONEMAP:1}:{},uniforms:{uSunDir:{value:t},uMoonDir:{value:n},uCloudCoverage:r,uFogColor:i.color,uFogNear:i.near,uFogFar:i.far},side:1,depthWrite:!1,depthTest:!0})}var af=class{sunDirection=new G(0,1,0);moonDirection=new G(0,1,0);skybox;renderer;target;cubeCamera;cubeScene;coverage={value:0};fog={color:{value:new Y(1,1,1)},near:{value:0},far:{value:1e9}};lastTime=NaN;lastCoverage=NaN;lastFog=``;constructor(e){this.renderer=e,this.target=new Bs(Hd,{type:y,generateMipmaps:!1,minFilter:l,magFilter:l}),this.cubeCamera=new Bo(.1,10,this.target),this.cubeScene=new Fn;let t=new ca(2,2,2),n=new oi(t,rf(!1,this.sunDirection,this.moonDirection,this.coverage,this.fog));n.frustumCulled=!1,this.cubeScene.add(n),this.skybox=new oi(t,rf(!0,this.sunDirection,this.moonDirection,this.coverage,this.fog)),this.skybox.frustumCulled=!1,this.skybox.renderOrder=-1}get cubemap(){return this.target.texture}get moonIntensity(){return tf(this.sunDirection)}sunColor(e=new Y){let t=this.sunDirection.y,n=1-nf(0,Md.sunWarmEl,t),r=nf(Md.sunFadeEl,0,t);return e.copy(Yd).lerp(Xd,n*n).multiplyScalar(r)}ambient(e={sky:new Y,ground:new Y}){let t=this.sunDirection.y,n=nf(Md.dayElLo,Md.dayElHi,t),r=e.sky.copy(Kd).lerp(Wd,n),i=e.ground.copy(qd).lerp(Gd,n);return r.lerp(i,.5),i.multiplyScalar(.35).lerp(Jd,.5),e}version=0;invalidate(){this.lastTime=NaN,this.lastCoverage=NaN,this.lastFog=``}update(e,t,n){let r=`${n.color}/${n.near}/${n.far}`;(e!==this.lastTime||t!==this.lastCoverage||r!==this.lastFog)&&(this.version++,this.lastTime=e,this.lastCoverage=t,this.lastFog=r,Zd(e,this.sunDirection),ef(this.sunDirection,this.moonDirection),this.coverage.value=t,this.fog.color.value.set(n.color),this.fog.near.value=n.near,this.fog.far.value=n.far,this.cubeCamera.update(this.renderer,this.cubeScene))}dispose(){this.target.dispose(),this.skybox.material.dispose(),this.skybox.geometry.dispose(),this.cubeScene.traverse(e=>{e instanceof oi&&e.material.dispose()})}},of=`precision highp float;
...
`,cf=3,lf;function uf(){return lf||(lf=new bi(new Float32Array([0,0,0,0]),1,1,D,v),lf.needsUpdate=!0),lf}function df(e){return new Y(e)}var ff=class extends Ea{cascadeCount;constructor(e){let t=Math.max(1,Math.min(cf,e));super({glslVersion:Ke,vertexShader:zd(of),fragmentShader:zd(sf),defines:{CASCADES:t},uniforms:{uOrigin:{value:new W},uBaseCell:{value:1},uSizes:{value:new G(1,1,1)},uChoppiness:{value:1},uDisp0:{value:uf()},uDisp1:{value:uf()},uDisp2:{value:uf()},uDeriv0:{value:uf()},uDeriv1:{value:uf()},uDeriv2:{value:uf()},uFoam0:{value:uf()},uFoam1:{value:uf()},uFoam2:{value:uf()},uWakeTex:{value:uf()},uWakeOrigin:{value:new W},uWakeSize:{value:0},uRainField:{value:uf()},uRainOrigin:{value:new W},uRainSize:{value:0},uRainIntensity:{value:0},uSky:{value:null},uSunDir:{value:new G(0,1,0)},uSunIntensity:{value:1.5},uSunElevation:{value:1},uMoonDir:{value:new G(0,1,0)},uMoonIntensity:{value:0},uWaterColor:{value:new Y},uAbsorption:{value:new Y},uTransmission:{value:new Y},uDepth:{value:30},uSssIntensity:{value:1},uSssPower:{value:4},uF0:{value:.02},uIor:{value:1.33},uRefraction:{value:.1},uFoamEnabled:{value:1},uFogColor:{value:new Y},uFogNear:{value:500},uFogFar:{value:1800},uCloudCoverage:{value:0},uUnderwater:{value:0},uSceneColor:{value:uf()},uSceneDepth:{value:uf()},uSsr:{value:1},uTime:{value:0},uTerrainTex:{value:uf()},uTerrainOrigin:{value:new W},uTerrainSize:{value:0}},side:2}),this.cascadeCount=t}setParams(e){let t=this.uniforms;t.uChoppiness.value=e.waves.choppiness,t.uWaterColor.value=df(e.color.waterColor),t.uAbsorption.value=df(e.color.absorptionColor),t.uTransmission.value=df(e.color.transmissionColor),t.uDepth.value=e.color.depth,t.uSssIntensity.value=e.sss.intensity,t.uSssPower.value=e.sss.power;let n=e.fresnel.iorRatio;t.uIor.value=n,t.uF0.value=((n-1)/(n+1))**2,t.uRefraction.value=e.fresnel.refractionStrength,t.uSsr.value=e.fresnel.ssr&&Du(e.quality).ssr?1:0,t.uFoamEnabled.value=+!!e.foam.enabled,t.uFogColor.value=df(e.fog.color),t.uFogNear.value=e.fog.near,t.uFogFar.value=e.fog.far,t.uSunIntensity.value=e.sun.intensity,t.uCloudCoverage.value=e.sky.cloudCoverage}setCascades(e){let t=this.uniforms,n=t.uSizes.value,r=[1,1,1];for(let n=0;n<cf;n++){let i=e[n];t[`uDisp${n}`].value=i?i.displacement:uf(),t[`uDeriv${n}`].value=i?i.derivatives:uf(),t[`uFoam${n}`].value=i?.foam??uf(),i&&(r[n]=i.size)}n.set(r[0],r[1],r[2])}setSky(e,t,n,r){let i=this.uniforms;i.uSky.value=e,i.uSunDir.value.copy(t),i.uSunElevation.value=t.y,i.uMoonDir.value.copy(n),i.uMoonIntensity.value=r}setOrigin(e,t,n){this.uniforms.uOrigin.value.set(e,t),this.uniforms.uBaseCell.value=n}setScene(e,t){this.uniforms.uSceneColor.value=e,this.uniforms.uSceneDepth.value=t}setTerrain(e,t=0,n=0,r=0){let i=this.uniforms;i.uTerrainTex.value=e??uf(),i.uTerrainOrigin.value.set(t,n),i.uTerrainSize.value=e?r:0}setTime(e){this.uniforms.uTime.value=e}setUnderwater(e){this.uniforms.uUnderwater.value=+!!e}setWake(e,t=0,n=0,r=0){let i=this.uniforms;i.uWakeTex.value=e??uf(),i.uWakeOrigin.value.set(t,n),i.uWakeSize.value=e?r:0}setRain(e,t=0,n=0,r=0,i=0){let a=this.uniforms,o=e!==null&&i>0;a.uRainField.value=e??uf(),a.uRainOrigin.value.set(t,n),a.uRainSize.value=o?r:0,a.uRainIntensity.value=o?i:0}},pf=class extends En{sim;sky;scenePass;material;mesh;params;baseCell;rings;renderer;terrain=null;timer;skyVersion=-1;constructor(e,t,n={}){super(),this.name=`Ocean`,this.renderer=e,this.params=Ou(t),this.timer=n.timer??Nu,this.sim=n.sim??new Dd(e,this.params),this.sim instanceof Dd&&(this.sim.timer=this.timer),this.baseCell=n.baseCell??1,this.rings=n.rings??10,this.sky=new af(e),this.add(this.sky.skybox),this.scenePass=new Ad(e),this.buildSurface()}setParams(e){let t=this.params.quality;this.params=Ou(e),this.sim.setParams(this.params),e.quality===t?this.material.setParams(this.params):this.buildSurface()}contextRestored(){this.sim.contextRestored?.(),this.sky.invalidate(),this.buildSurface(!0)}buildSurface(e=!1){this.mesh!==void 0&&(this.remove(this.mesh),e||(this.mesh.geometry.dispose(),this.material.dispose()));let t=Du(this.params.quality);this.material=new ff(this.sim.cascades.length),this.material.setParams(this.params),this.material.setSky(this.sky.cubemap,this.sky.sunDirection,this.sky.moonDirection,this.sky.moonIntensity),this.skyVersion=this.sky.version,this.material.setCascades(this.sim.cascades),this.material.setScene(this.scenePass.color,this.scenePass.depth),this.terrain&&this.material.setTerrain(this.terrain.tex,this.terrain.x,this.terrain.z,this.terrain.extent),this.mesh=new oi(Od(t.meshSegments,this.rings,this.baseCell),this.material),this.mesh.frustumCulled=!1,this.mesh.name=`OceanSurface`,this.add(this.mesh)}update(e,t,n){let r=this.renderer.getRenderTarget();this.sim.update(t,n),this.renderer.setRenderTarget(r),this.sky.update(this.params.sky.timeOfDay,this.params.sky.cloudCoverage,this.params.fog),this.sky.version!==this.skyVersion&&(this.skyVersion=this.sky.version,this.material.setSky(this.sky.cubemap,this.sky.sunDirection,this.sky.moonDirection,this.sky.moonIntensity)),this.material.setCascades(this.sim.cascades),this.material.setTime(t);let[i,a]=kd(e.position.x,e.position.z,this.baseCell*2);this.material.setOrigin(i,a,this.baseCell)}setTerrain(e,t=0,n=0,r=0){this.terrain=e?{tex:e,x:t,z:n,extent:r}:null,this.material.setTerrain(e,t,n,r)}renderSceneDepth(e,t){this.timer.begin(`prepass`),this.scenePass.render(e,t),this.timer.end(),this.material.setScene(this.scenePass.color,this.scenePass.depth)}stats(){let e=0,t=0;return this.traverseVisible(n=>{if(!(n instanceof oi))return;let r=n.geometry;e++,t+=(r.index?r.index.count:r.getAttribute(`position`).count)/3}),{draws:e,tris:t}}dispose(){this.mesh.geometry.dispose(),this.material.dispose(),this.sky.dispose(),this.scenePass.dispose(),this.sim.dispose()}},mf=[{x:235,z:-70,r:14,h:20},{x:-215,z:120,r:11,h:15}];function hf(e,t,n){let r=Math.imul(e,668265261)^Math.imul(t,374761393)^Math.imul(n|0,2654435761);return r=Math.imul(r^r>>>15,2246822507),r=Math.imul(r^r>>>13,3266489909),r^=r>>>16,(r>>>0)/4294967296}function gf(e){return e*e*(3-2*e)}function _f(e,t,n){let r=Math.floor(e),i=Math.floor(t),a=gf(e-r),o=gf(t-i),s=hf(r,i,n),c=hf(r+1,i,n),l=hf(r,i+1,n),u=hf(r+1,i+1,n);return(s+(c-s)*a)*(1-o)+(l+(u-l)*a)*o}function vf(e,t,n,r=4){let i=0,a=1,o=0;for(let s=0;s<r;s++)i+=_f(e,t,n+s*101)*a,o+=a,e=e*2.03+17.1,t=t*1.97+9.7,a*=.5;return i/o}function yf(e,t,n){return gf(Math.min(1,Math.max(0,(n-e)/(t-e))))}function bf(e,t,n){let r=Math.hypot(e,t)+(vf(e*.006,t*.006,n+7,3)-.5)*90-175,i=-r,a;if(r>0)a=-Math.min(r/8,6)-4*yf(0,150,r)-40*yf(280,420,r);else{let r=i/175,o=Math.min(i/8,2.5)+Math.max(i-20,0)/12,s=26*(vf(e*.02,t*.02,n,5)-.35)*yf(.08,.35,r),c=vf(e*.05,t*.05,n+3,4),l=1-Math.abs(vf(e*.03,t*.03,n+5,3)*2-1),u=60*Math.max(r,0)**2*(.55+.6*c+.35*l);a=Math.min(o,6)+Math.max(o-6,0)*.3+s+u,a=Math.max(a,Math.min(i/8,1))}for(let r of mf){let i=Math.hypot(e-r.x,t-r.z)/r.r;if(i<2.5){let o=.8+.4*vf(e*.15,t*.15,n+11,3),s=r.h*o*Math.exp(-i*i*i);a+=s}}return a}function xf(e,t,n){let r=new Float32Array(e*e),i=t/(e-1);for(let a=0;a<e;a++){let o=-t/2+a*i;for(let s=0;s<e;s++){let c=-t/2+s*i;r[a*e+s]=bf(c,o,n)}}return r}var Sf=`precision highp float;
...
`,wf=new G(-70,0,-450),Tf=class extends oi{seed;extent;resolution;heightTexture;constructor(e,t={}){let n=t.resolution??256,r=t.extent??1200,a=xf(n,r,e),o=new ma(r,r,n-1,n-1);o.rotateX(-Math.PI/2);let s=o.getAttribute(`position`);for(let e=0;e<n*n;e++)s.setY(e,a[e]);s.needsUpdate=!0,o.computeVertexNormals(),o.computeBoundingSphere();let c=new Ea({glslVersion:Ke,vertexShader:Sf,fragmentShader:zd(Cf),uniforms:{uSky:{value:null},uSunDir:{value:new G(0,1,0)},uSunIntensity:{value:1.5},uSunElevation:{value:1},uFogColor:{value:new Y},uFogNear:{value:500},uFogFar:{value:1800},uTime:{value:0},uUnderwater:{value:0},uWaterColor:{value:new Y},uAbsorption:{value:new Y},uLinearOut:{value:0}}});super(o,c),this.seed=e,this.extent=r,this.resolution=n,this.name=`Terrain`,this.userData.castsWaterDepth=!0,this.position.copy(t.position??wf);let u=new Uint16Array(n*n);for(let e=0;e<n*n;e++)u[e]=hr.toHalfFloat(a[e]);this.heightTexture=new bi(u,n,n,A,y),this.heightTexture.minFilter=l,this.heightTexture.magFilter=l,this.heightTexture.wrapS=i,this.heightTexture.wrapT=i,this.heightTexture.generateMipmaps=!1,this.heightTexture.needsUpdate=!0}attachTo(e){e.setTerrain(this.heightTexture,this.position.x-this.extent/2,this.position.z-this.extent/2,this.extent)}setParams(e){let t=this.material.uniforms;t.uFogColor.value.set(e.fog.color),t.uFogNear.value=e.fog.near,t.uFogFar.value=e.fog.far,t.uSunIntensity.value=e.sun.intensity,t.uWaterColor.value.set(e.color.waterColor),t.uAbsorption.value.set(e.color.absorptionColor)}update(e,t,n){let r=this.material.uniforms;r.uSky.value=e.cubemap,r.uSunDir.value.copy(e.sunDirection),r.uSunElevation.value=e.sunDirection.y,r.uTime.value=t,r.uUnderwater.value=+!!n}heightAt(e,t){let n=this.resolution,r=e-this.position.x,i=t-this.position.z,a=this.extent/(n-1),o=Math.round((r+this.extent/2)/a),s=Math.round((i+this.extent/2)/a);return o<0||s<0||o>=n||s>=n?-1/0:this.geometry.getAttribute(`position`).getY(s*n+o)+this.position.y}dispose(){this.geometry.dispose(),this.material.dispose(),this.heightTexture.dispose()}},Ef=`// Underwater sun shafts (spec §1.13): Mitchell 2007, "Volumetric light
...
#endif
`,Df=new Y(1,1,1),Of=zd(Ef),kf=20,Af=class{renderer;options={density:.85,decay:.975,weight:.075,exposure:1,maxLength:1,threshold:.5,knee:.95};sunDirW=new G(0,1,0);sunUv=new W(.5,.5);strength=0;frame;mask;shafts;maskPass;blurPass;compositePass;size=new W;tint=new Y;tmp=new G;constructor(e){this.renderer=e,this.frame=new Xt(1,1,{type:f,format:D,colorSpace:ze,minFilter:l,magFilter:l,generateMipmaps:!1,depthBuffer:!0,stencilBuffer:!1,samples:4}),this.frame.texture.name=`SunShaftsFrame`,this.frame.texture.internalFormat=`RGBA8`,this.frame.isXRRenderTarget=!0;let t=e=>{let t=new Xt(1,1,{type:f,format:D,minFilter:l,magFilter:l,generateMipmaps:!1,depthBuffer:!1,stencilBuffer:!1});return t.texture.name=e,t};this.mask=t(`SunShaftsMask`),this.shafts=t(`SunShaftsBlur`),this.maskPass=new Uu(Of,{uSize:{value:new W(1,1)},uFrame:{value:this.frame.texture},uInvProj:{value:new J},uInvViewRot:{value:new K},uSunDirW:{value:this.sunDirW},uCamPos:{value:new G},uSurfaceY:{value:0},uCausticScale:{value:65},uTime:{value:0},uThreshold:{value:.3},uKnee:{value:.8}},{defines:{STAGE_MASK:1}}),this.blurPass=new Uu(Of,{uSize:{value:new W(1,1)},uMask:{value:this.mask.texture},uSunUv:{value:this.sunUv},uDensity:{value:1},uDecay:{value:.95},uWeight:{value:.05},uMaxLen:{value:1}},{defines:{STAGE_BLUR:1}}),this.compositePass=new Uu(Of,{uSize:{value:new W(1,1)},uFrame:{value:this.frame.texture},uShafts:{value:this.shafts.texture},uTint:{value:this.tint}},{defines:{STAGE_COMPOSITE:1}})}get active(){return this.strength>.001}update(e,t,n,r,i,a){let o=t.sunDirection,s=this.maskPass.uniforms;s.uCamPos.value.copy(e.position),s.uSurfaceY.value=e.position.y+r,s.uCausticScale.value=i.scale,s.uTime.value=a;let c=Math.max(1,n.fresnel.iorRatio),l=Math.sqrt(Math.max(0,1-o.y*o.y))/c,u=Math.hypot(o.x,o.z);u>1e-6?this.sunDirW.set(o.x/u*l,Math.sqrt(1-l*l),o.z/u*l):this.sunDirW.set(0,1,0);let d=this.tmp.copy(this.sunDirW).transformDirection(e.matrixWorldInverse),f=e.projectionMatrix.elements,p=Math.max(-d.z,.05);this.sunUv.set(f[0]*d.x/p*.5+.5,f[5]*d.y/p*.5+.5);let m=jf(-.15,.25,e.getWorldDirection(this.tmp).dot(this.sunDirW)),h=jf(-.02,.18,o.y)*(n.sun.intensity/1.5),g=Math.exp(-Math.max(0,r)/kf),_=+!!n.underwater.sunShafts;this.strength=_*m*h*g,t.sunColor(this.tint).lerp(Df,.35).multiplyScalar(this.strength*this.options.exposure)}render(e,t,n=Nu){let r=this.renderer;r.getDrawingBufferSize(this.size);let i=Math.max(1,Math.floor(this.size.x)),a=Math.max(1,Math.floor(this.size.y)),o=Math.max(1,Math.floor(i/2)),s=Math.max(1,Math.floor(a/2));(this.frame.width!==i||this.frame.height!==a)&&this.frame.setSize(i,a),(this.mask.width!==o||this.mask.height!==s)&&(this.mask.setSize(o,s),this.shafts.setSize(o,s)),n.begin(`water`),r.setRenderTarget(this.frame),r.clear(),r.render(e,t),n.end(),n.begin(`post`);let c=this.options,l=this.maskPass.uniforms;l.uSize.value.set(o,s),l.uInvProj.value.copy(t.projectionMatrixInverse),l.uInvViewRot.value.setFromMatrix4(t.matrixWorld),l.uThreshold.value=c.threshold,l.uKnee.value=c.knee,this.maskPass.render(r,this.mask);let u=this.blurPass.uniforms;u.uSize.value.set(o,s),u.uDensity.value=c.density,u.uDecay.value=c.decay,u.uWeight.value=c.weight,u.uMaxLen.value=c.maxLength,this.blurPass.render(r,this.shafts),this.compositePass.uniforms.uSize.value.set(i,a),this.compositePass.render(r,null),n.end()}dispose(){this.frame.dispose(),this.mask.dispose(),this.shafts.dispose(),this.maskPass.dispose(),this.blurPass.dispose(),this.compositePass.dispose()}};function jf(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}var Mf=`
precision highp float;
in vec3 position;
uniform mat4 projectionMatrix;
uniform mat4 viewMatrix;
...
mvPosition = modelViewMatrix * mvPosition;
gl_Position = projectionMatrix * mvPosition;`)},e.customProgramCacheKey=()=>`sway-${e.name}`,e}setPalmMeshes(e){for(let e of this.palmMeshes)this.remove(e),e.geometry.dispose(),e.dispose();this.palmMeshes=e;for(let t of e)t.userData.castsWaterDepth=!0,t.castShadow=!1,t.receiveShadow=!1,t.frustumCulled=!1,this.add(t)}instance(e,t,n){let r=e.map(()=>[]);this.palms.forEach((t,n)=>r[n%e.length].push(t));let i=new J,a=new jt,o=new ln,s=new G,c=new G;return e.map((e,l)=>{let u=r[l],d=new Mi(e,t,Math.max(u.length,1));d.name=`Palms${l}`,d.count=u.length;let f=this.palmHeight*n[l];return u.forEach((e,t)=>{o.set(e.leanAmount*.12*Math.sin(e.lean),e.yaw,e.leanAmount*.12*Math.cos(e.lean),`YXZ`),a.setFromEuler(o),s.setScalar(f*e.scale),c.set(e.x,e.y-.2,e.z),i.compose(c,a,s),d.setMatrixAt(t,i)}),d.instanceMatrix.needsUpdate=!0,d})}buildProceduralPalms(e){let t=[dm(10,.35,e),dm(10,.8,e+1),dm(8,.15,e+2)].map(cm);this.setPalmMeshes(this.instance(t,[this.trunkMat,this.frondMat],[1,1,.8])),this.palmModel=`procedural`}async loadGltfPalms(e,t){try{let n=await Promise.all(t.map(t=>e.loadAsync(t)));if(this.disposed)return;let r=[],i=[];for(let e of n){e.scene.updateMatrixWorld(!0);let t=[],n=[];e.scene.traverse(e=>{if(!(e instanceof oi))return;let r=Array.isArray(e.material)?e.material[0]:e.material,i=e.geometry.clone().applyMatrix4(e.matrixWorld);for(let e of Object.keys(i.attributes))e!==`position`&&e!==`normal`&&e!==`uv`&&i.deleteAttribute(e);(/leaf|frond/i.test(r.name)?n:t).push(i),r.dispose(),e.geometry.dispose()});let a=[...t,...n],o=Ff(a,!0);if(!o)throw Error(`palm glTF merge failed`);o.clearGroups();let s=e=>e.index?e.index.count:e.getAttribute(`position`).count,c=t.reduce((e,t)=>e+s(t),0),l=a.reduce((e,t)=>e+s(t),0);o.addGroup(0,c,0),o.addGroup(c,l-c,1),o.computeBoundingBox();for(let e of a)e.dispose();i.push(o.boundingBox.max.y-o.boundingBox.min.y),r.push(cm(o))}let a=Math.max(...i);this.setPalmMeshes(this.instance(r,[this.gltfTrunkMat,this.gltfFrondMat],i.map(e=>e/a))),this.palmModel=`gltf`}catch(e){console.warn(`palm glTF unavailable, keeping the procedural palms: ${String(e)}`)}}buildRocks(e){let t=new J,n=new jt,r=[];this.rocks.forEach((i,a)=>{let o=2.5+3.5*i.scale;for(let s=0;s<3;s++){let c=fm(e+a*17+s*5),l=s===0?1:.45+.2*s,u=i.yaw+s*2.1,d=s===0?0:o*(.9+.3*s),f=i.x+Math.cos(u)*d,p=i.z+Math.sin(u)*d;n.setFromEuler(new ln(.3*(i.leanAmount-.5),i.yaw+s,.2*s)),t.compose(new G(f,i.y-.4*o*l,p),n,new G(o*l*1.3,o*l*.8,o*l)),r.push(c.applyMatrix4(t))}});let i=Ff(r,!1);if(!i)throw Error(`rock merge failed`);for(let e of r)e.dispose();let a=new oi(i,this.rockMat);return a.name=`Rocks`,a.userData.castsWaterDepth=!0,a.frustumCulled=!1,a}dispose(){this.disposed=!0,this.setPalmMeshes([]),this.rockMesh.geometry.dispose();for(let e of[this.trunkMat,this.frondMat,this.gltfTrunkMat,this.gltfFrondMat,this.rockMat])e.dispose();for(let e of this.textures)e.dispose()}},mm=class{hull;hullBelow;deck;spar;wale;sail;iron;gilt;glass;rope;ropeLine;flag;textures=[];constructor(e=512){let t=this.keep($p(Yp(e,{metres:4,plankWidth:.3,plankLength:2.2,seed:3,tint:[.66,.46,.27]}))),n=this.keep($p(Yp(e,{metres:4,plankWidth:.22,plankLength:3,seed:8,tint:[.72,.58,.4]}))),r=this.keep($p(Yp(256,{metres:2,plankWidth:2,plankLength:2,seed:4,tint:[.36,.25,.15]}))),i=this.keep($p(Xp(e,{metres:10,panel:.6}))),a=this.keep($p(Zp(64))),o=(e,t={})=>new Da({map:e.map,roughnessMap:e.roughnessMap,normalMap:e.normalMap,normalScale:new W(.8,.8),roughness:1,metalness:0,...t});this.hull=o(t,{name:`ship-hull`}),this.hullBelow=o(t,{name:`ship-hull-below`,color:5919552,roughness:.95}),this.deck=o(n,{name:`ship-deck`}),this.spar=o(r,{name:`ship-spar`,roughness:.75}),this.wale=new Da({name:`ship-wale`,color:2103312,roughness:.8,metalness:0}),this.sail=o(i,{name:`ship-sail`,side:2,alphaTest:.5,color:14997954,emissive:new Y(15261900),emissiveIntensity:.1,normalScale:new W(.35,.35)}),this.iron=new Da({name:`ship-iron`,color:1842464,roughness:.55,metalness:.8}),this.gilt=new Da({name:`ship-gilt`,color:14266954,roughness:.4,metalness:.7}),this.glass=new Da({name:`ship-glass`,color:12110548,roughness:.2,metalness:.3,emissive:3820122,emissiveIntensity:.6}),this.rope=o(a,{name:`ship-rope`,roughness:.9}),this.ropeLine=new Li({name:`ship-rope-line`,color:1709072}),this.flag=new Da({name:`ship-flag`,color:11736094,roughness:.9,side:2})}keep(e){return this.textures.push(e),e}all(){return[this.hull,this.hullBelow,this.deck,this.spar,this.wale,this.sail,this.iron,this.gilt,this.glass,this.rope,this.ropeLine,this.flag]}dispose(){for(let e of this.all())e.dispose();for(let e of this.textures)e.dispose()}},hm=null;function gm(){return hm??=new mm,hm}var _m=4,vm=96,ym=4,bm=class{sim;blocks=[];requests=[];stitch=[];lastFrameX=NaN;lastFrameZ=NaN;scratch={height:0,dx:0,dz:0};slotBase;constructor(e,t={}){this.sim=e,this.slotBase=t.slotBase??0}update(e,t,n=0){this.lastFrameX=e,this.lastFrameZ=t,this.blocks.length=0;for(let e of this.requests){let t=this.assemble(e);t&&this.blocks.push({x0:e.x0,y0:e.y0,w:e.w,h:e.h,data:t,N:e.N,size:e.size})}this.requests.length=0,this.sim.cascades.forEach((r,i)=>{let{N:a,size:o}=r,s=o/a,c=_m;if(n>0){if(c=Math.ceil(2*n/s)+_m,c>vm)return;c=Math.min(c,a)}let[l,u]=Cm(e,t,a,o),d=Math.floor(l)-(c>>1)+1,f=Math.floor(u)-(c>>1)+1,p=Sm(d,c,a),m=Sm(f,c,a),h=[],g=this.slotBase+i*ym;for(let e of m)for(let t of p)this.sim.issueDisplacementBlock(g,i,t.start,e.start,t.len,e.len),h.push({slot:g++,sx:t,sy:e});this.requests.push({x0:d,y0:f,w:c,h:c,N:a,size:o,pieces:h})})}assemble(e){if(e.pieces.length===1)return this.sim.consumeDisplacementBlock(e.pieces[0].slot);let t=Math.floor(e.pieces[0].slot/ym),n=e.w*e.h*4,r=this.stitch[t];(!r||r.length!==n)&&(r=new Float32Array(n),this.stitch[t]=r);for(let t of e.pieces){let n=this.sim.consumeDisplacementBlock(t.slot);if(!n)return null;let{sx:i,sy:a}=t;for(let t=0;t<a.len;t++){let o=t*i.len*4,s=((a.offset+t)*e.w+i.offset)*4;r.set(n.subarray(o,o+i.len*4),s)}}return r}covers(e,t){if(this.blocks.length===0)return!1;for(let n of this.blocks){let r=(e/n.size-Math.floor(e/n.size))*n.N-.5,i=(t/n.size-Math.floor(t/n.size))*n.N-.5,a=Math.floor(r),o=Math.floor(i),s=((a-n.x0)%n.N+n.N)%n.N,c=((o-n.y0)%n.N+n.N)%n.N;if(s+1>n.w-1||c+1>n.h-1)return!1}return!0}heightAt(e,t){if(this.blocks.length===0)return 0;let n=e,r=t,i=this.scratch;for(let a=0;a<2;a++)this.sampleAt(n,r,i),n=e-i.dx,r=t-i.dz;return this.sampleAt(n,r,i).height}sampleAt(e,t,n={height:0,dx:0,dz:0}){let r=0,i=0,a=0;for(let n of this.blocks){let o=(e/n.size-Math.floor(e/n.size))*n.N-.5,s=(t/n.size-Math.floor(t/n.size))*n.N-.5,c=Math.floor(o),l=Math.floor(s),u=o-c,d=s-l,f=wm(n,c,l),p=wm(n,c+1,l),m=wm(n,c,l+1),h=wm(n,c+1,l+1),g=n.data,_=(1-u)*(1-d),v=u*(1-d),y=(1-u)*d,b=u*d;i+=g[f]*_+g[p]*v+g[m]*y+g[h]*b,r+=g[f+1]*_+g[p+1]*v+g[m+1]*y+g[h+1]*b,a+=g[f+2]*_+g[p+2]*v+g[m+2]*y+g[h+2]*b}return n.height=r,n.dx=i,n.dz=a,n}get probe(){return[this.lastFrameX,this.lastFrameZ]}};function xm(e,t,n){return e<t?t:e>n?n:e}function Sm(e,t,n){let r=(e%n+n)%n;if(r+t<=n)return[{start:r,len:t,offset:0}];let i=n-r;return[{start:r,len:i,offset:0},{start:0,len:t-i,offset:i}]}function Cm(e,t,n,r){let i=e/r-Math.floor(e/r),a=t/r-Math.floor(t/r);return[i*n,a*n]}function wm(e,t,n){let r=xm(((t-e.x0)%e.N+e.N)%e.N,0,e.w-1);return(xm(((n-e.y0)%e.N+e.N)%e.N,0,e.h-1)*e.w+r)*4}var Tm={volume:[60,42,60],fallSpeed:13,fallJitter:.25,windCarry:.18,streakSeconds:.07,poolCapacity:4096,rateMax:6e3,life:.55,lifeJitter:.35,r0:.04,ringSpeed:.55,ringWidth:.18,fieldSize:64};function Em(e,t,n=.5,r=Tm){let i=r.fallSpeed*(1+r.fallJitter*(n*2-1)),a=t*r.windCarry;return[e[0]*a,-i,e[1]*a]}function Dm(e,t=Tm){return .5*Math.hypot(e[0],e[1],e[2])*t.streakSeconds}function Om(e,t){let n=Math.min(1,Math.max(0,t));return n<=0?0:Math.max(1,Math.round(e*Math.sqrt(n)))}function km(e,t,n){let r=e+t*n,i=Math.floor(r);return{spawn:i,carry:r-i}}function Am(e,t){return Math.floor(e/t)*t}var jm=class{capacity;tuning;x;z;born;life;head=0;carry=0;rng;constructor(e=Tm.poolCapacity,t=20260912,n=Tm){this.capacity=e,this.tuning=n,this.x=new Float32Array(e),this.z=new Float32Array(e),this.born=new Float32Array(e).fill(-1e9),this.life=new Float32Array(e).fill(1),this.rng=ad(t)}reset(){this.born.fill(-1e9),this.head=0,this.carry=0}step(e,t,n,r,i){let a=this.tuning,o=Math.min(1,Math.max(0,n))*a.rateMax,s=km(this.carry,o,Math.max(0,t));this.carry=s.carry;let c=a.fieldSize/2;for(let t=0;t<s.spawn;t++){let t=this.head;this.head=(this.head+1)%this.capacity,this.x[t]=r+(this.rng()*2-1)*c,this.z[t]=i+(this.rng()*2-1)*c,this.born[t]=e,this.life[t]=a.life*(1+a.lifeJitter*(this.rng()*2-1))}}collect(e){let t=[];for(let n=0;n<this.capacity;n++){let r=e-this.born[n],i=this.life[n];r<0||r>=i||t.push({x:this.x[n],z:this.z[n],age01:r/i,life:i})}return t}fillAttributes(e,t){let n=0;for(let r=0;r<this.capacity;r++){let i=e-this.born[r],a=this.life[r];i<0||i>=a||(t[n*4]=this.x[r],t[n*4+1]=this.z[r],t[n*4+2]=i/a,t[n*4+3]=a,n++)}return n}countAt(e){let t=0;for(let n=0;n<this.capacity;n++){let r=e-this.born[n];r>=0&&r<this.life[n]&&t++}return t}},Mm=`// Rain-ripple stamp (spec §1.16): one expanding ring per live drop,
...
}`,Pm=class{N;target;size;origin=[0,0];liveCount=0;scene=new Fn;camera=new jo(-1,1,1,-1,0,1);mesh;material;instances;data;tmpClear=new Y;constructor(e=512,t=Tm.poolCapacity,n=!1,r=Tm){this.N=e,this.size=r.fieldSize;let a=Wu(e,1,{linear:n});a.texture.wrapS=i,a.texture.wrapT=i,this.target=a;let o=new ma(2,2),s=new Fo;s.index=o.index,s.setAttribute(`position`,o.getAttribute(`position`)),this.data=new Float32Array(t*4),this.instances=new wi(this.data,4),this.instances.setUsage(Ge),s.setAttribute(`aRipple`,this.instances),s.instanceCount=0,this.material=new Ea({glslVersion:Ke,vertexShader:Nm,fragmentShader:Mm,uniforms:{uOrigin:{value:new W},uSize:{value:this.size},uR0:{value:r.r0},uRingSpeed:{value:r.ringSpeed},uRingWidth:{value:r.ringWidth}},depthTest:!1,depthWrite:!1,blending:5,blendEquation:100,blendSrc:201,blendDst:201,blendSrcAlpha:201,blendDstAlpha:201,side:2}),this.mesh=new oi(s,this.material),this.mesh.frustumCulled=!1,this.scene.add(this.mesh)}get texture(){return this.target.texture}update(e,t,n,r,i){let a=this.size/this.N;this.origin[0]=Am(r,a)-this.size/2,this.origin[1]=Am(i,a)-this.size/2;let o=t.fillAttributes(n,this.data);this.liveCount=o;let s=this.mesh.geometry;s.instanceCount=o,this.instances.needsUpdate=!0,this.material.uniforms.uOrigin.value.set(this.origin[0],this.origin[1]);let c=e.getRenderTarget(),l=e.getClearColor(this.tmpClear).getHex(),u=e.getClearAlpha();e.setRenderTarget(this.target),e.setClearColor(0,0),e.clear(!0,!1,!1),o>0&&e.render(this.scene,this.camera),e.setRenderTarget(c),e.setClearColor(l,u)}clear(e){this.liveCount=0,this.mesh.geometry.instanceCount=0;let t=e.getRenderTarget(),n=e.getClearColor(this.tmpClear).getHex(),r=e.getClearAlpha();e.setRenderTarget(this.target),e.setClearColor(0,0),e.clear(!0,!1,!1),e.setRenderTarget(t),e.setClearColor(n,r)}dispose(){this.mesh.geometry.dispose(),this.material.dispose(),this.target.dispose()}},Fm=8e3,Im=`
precision highp float;
precision highp int;
in vec3 position;
in vec4 aSeed;
...
}`,Rm=class{renderer;tuning;mesh;ripple;pool;intensity=0;material;tmpColor=new Y;tmpColor2=new Y;tmpAmbient={sky:new Y,ground:new Y};tmpDir=new G;halfVolume;active=!1;constructor(e,t=Tm){this.renderer=e,this.tuning=t,this.pool=new jm(t.poolCapacity,20260912,t),this.ripple=new Pm(512,t.poolCapacity,Ku(e),t),this.halfVolume=new G(...t.volume).multiplyScalar(.5);let n=new ma(2,2),r=new Fo;r.index=n.index,r.setAttribute(`position`,n.getAttribute(`position`));let i=new Float32Array(Fm*4),a=ad(659918);for(let e=0;e<i.length;e++)i[e]=a();r.setAttribute(`aSeed`,new wi(i,4)),r.instanceCount=0,this.material=new Ea({glslVersion:Ke,vertexShader:Im,fragmentShader:zd(Lm),uniforms:{uTime:{value:0},uVolume:{value:new G(...t.volume)},uBoxMin:{value:new G},uVelBase:{value:new G(0,-t.fallSpeed,0)},uFallJitter:{value:t.fallJitter},uHalfLen:{value:.3},uProjScale:{value:1},uIntensity:{value:0},uColor:{value:new Y(.5,.55,.6)},uOpacity:{value:.5}},transparent:!0,depthTest:!0,depthWrite:!1,blending:5,blendEquation:100,blendSrc:201,blendDst:205,blendSrcAlpha:201,blendDstAlpha:205,side:2}),this.mesh=new oi(r,this.material),this.mesh.frustumCulled=!1,this.mesh.renderOrder=21,this.mesh.name=`Rain`,this.mesh.visible=!1}get streaks(){return this.mesh.geometry.instanceCount*+!!this.mesh.visible}get ripples(){return this.ripple.liveCount}get fieldSize(){return this.ripple.size}get fieldOrigin(){return this.ripple.origin}reset(){this.pool.reset()}update(e){let t=e.params.weather,n=Math.min(1,Math.max(0,t.rain));if(!(t.rainEnabled&&Du(e.params.quality).rain&&n>0)){this.active&&(this.pool.reset(),this.ripple.clear(this.renderer)),this.active=!1,this.intensity=0,this.mesh.visible=!1;return}this.active=!0,this.intensity=n;let r=this.tuning,i=e.camera,a=Math.min(Math.max(e.dt,0),.05);this.pool.step(e.t,a,n,i.position.x,i.position.z),this.ripple.update(this.renderer,this.pool,e.t,i.position.x,i.position.z),this.mesh.visible=!e.hidden;let o=this.mesh.geometry;o.instanceCount=Om(Fm,n);let s=this.material.uniforms;s.uTime.value=e.t;let c=e.params.waves.windDirection,l=Em([Math.cos(c),Math.sin(c)],e.params.waves.windSpeed,.5,r);s.uVelBase.value.set(l[0],l[1],l[2]),s.uHalfLen.value=Dm(l,r),s.uIntensity.value=n,i.getWorldDirection(this.tmpDir),s.uBoxMin.value.copy(i.position).addScaledVector(this.tmpDir,.25*r.volume[2]).sub(this.halfVolume),s.uProjScale.value=e.bufferHeight*i.projectionMatrix.elements[5]/2;let u=e.params.sky.cloudCoverage,d=e.sky.ambient(this.tmpAmbient);this.tmpColor.copy(d.sky).lerp(this.tmpColor2.setRGB(.5,.5,.5),.4*u),e.sky.sunColor(this.tmpColor2).multiplyScalar(.2*(1-.8*u)),s.uColor.value.copy(this.tmpColor).multiplyScalar(2.4).add(this.tmpColor2)}dispose(){this.mesh.geometry.dispose(),this.material.dispose(),this.ripple.dispose()}},zm=`// Spray particle update (spec §1.14). One texel = one particle slot,
...
`,Bm=class{width;height;pingPong;current=0;pass;needsClear=!0;frame=0;constructor(e,t){this.width=e,this.height=t;let n=()=>{let n=Wu(e,2,{height:t});for(let e of n.textures)e.wrapS=i,e.wrapT=i;return n};this.pingPong=[n(),n()],this.pass=new Uu(zm,{uPrevA:{value:null},uPrevB:{value:null},uDisp0:{value:null},uFoam0:{value:null},uDisp1:{value:null},uFoam1:{value:null},uJac0:{value:null},uJac1:{value:null},uSizes:{value:new W(1,1)},uHasCascade1:{value:0},uDt:{value:0},uFrame:{value:0},uGravity:{value:9.81},uDragRate:{value:.8},uWindVel:{value:new G},uWindDir:{value:new W(1,0)},uWindSpeed:{value:0},uWindCarry:{value:.55},uFoamThreshold:{value:.9},uJacThreshold:{value:.8},uCrestP:{value:0},uCrestLife:{value:1.5},uCentre:{value:new W},uRadius:{value:100},uBowP:{value:0},uBowA:{value:new G},uBowB:{value:new G},uBowForward:{value:new W(0,-1)},uBowSpeed:{value:0},uBowLife:{value:1.2}})}get slots(){return this.width*this.height}get positions(){return this.pingPong[this.current].textures[0]}get velocities(){return this.pingPong[this.current].textures[1]}reset(){this.needsClear=!0}render(e,t){if(this.needsClear){for(let t of this.pingPong)e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1);this.needsClear=!1}let n=this.pingPong[this.current],r=this.pingPong[this.current^1],i=this.pass.uniforms;i.uPrevA.value=n.textures[0],i.uPrevB.value=n.textures[1],i.uDisp0.value=t.cascade0.displacement,i.uFoam0.value=t.cascade0.foam;let a=t.cascade1;i.uDisp1.value=a?a.displacement:t.cascade0.displacement,i.uFoam1.value=a?a.foam:t.cascade0.foam,i.uJac0.value=t.cascade0.jacobian,i.uJac1.value=a?a.jacobian:t.cascade0.jacobian,i.uSizes.value.set(t.cascade0.size,a?a.size:1),i.uHasCascade1.value=+!!a,i.uDt.value=t.dt,i.uFrame.value=this.frame=this.frame+1>>>0,i.uGravity.value=t.gravity,i.uDragRate.value=t.dragRate;let o=t.windSpeed*t.windCarry;i.uWindVel.value.set(t.windDir[0]*o,0,t.windDir[1]*o),i.uWindDir.value.set(t.windDir[0],t.windDir[1]),i.uWindSpeed.value=t.windSpeed,i.uWindCarry.value=t.windCarry,i.uFoamThreshold.value=t.foamThreshold,i.uJacThreshold.value=t.jacThreshold,i.uCrestP.value=t.crestP,i.uCrestLife.value=t.crestLife,i.uCentre.value.set(t.centre[0],t.centre[1]),i.uRadius.value=t.radius;let s=t.bow;i.uBowP.value=s?s.p:0,s&&(i.uBowA.value.set(s.a[0],s.a[1],s.a[2]),i.uBowB.value.set(s.b[0],s.b[1],s.b[2]),i.uBowForward.value.set(s.forward[0],s.forward[1]),i.uBowSpeed.value=s.speed,i.uBowLife.value=s.life),this.pass.render(e,r),this.current^=1}count(e){let t=e.getRenderTarget(),n=this.pingPong[this.current],r=rd(e,n,0,0,this.width,this.height,0),i=rd(e,n,0,0,this.width,this.height,1);e.setRenderTarget(t);let a=0,o=0;for(let e=0;e<this.slots;e++){let t=i[e*4+3],n=r[e*4+3];t===0||n>=Math.abs(t)||(t<0?o++:a++)}return{alive:a+o,crest:a,bow:o}}dispose(){this.pass.dispose(),this.pingPong[0].dispose(),this.pingPong[1].dispose()}},Vm={gravity:9.81,crestLife:1.5,bowLife:1.4,dragRate:.8,foamThreshold:.35,crestGain:100,bowGain:200,bowMinSpeed:2,windCarry:.55};function Hm(e,t,n=Vm){let r=Math.abs(e);return r<=n.bowMinSpeed?0:n.bowGain*r*r*t}function Um(e,t,n){return n>0?Math.min(1,e*t/n):0}function Wm(e){let t=e.filter(e=>e.local.x!==0);if(t.length===0)return[];let n=Math.min(...t.map(e=>e.local.z));return t.filter(e=>Math.abs(e.local.z-n)<1e-6).map(e=>({world:e.world,waterY:e.waterY,side:e.local.x<0?-1:1}))}var Gm=180,Km=130,qm=26,Jm=`
precision highp float;
precision highp int;
...
}`,Xm=class{renderer;tuning;pass;points;material;tmpDir=new G;tmpColor=new Y;tmpColor2=new Y;tmpAmbient={sky:new Y,ground:new Y};active=!1;constructor(e,t=Vm){this.renderer=e,this.tuning=t,this.pass=new Bm(Gm,Gm);let n=new Nr;n.setAttribute(`position`,new yr(new Float32Array(this.pass.slots*3),3)),this.material=new Ea({glslVersion:Ke,vertexShader:Jm,fragmentShader:zd(Ym),uniforms:{uPos:{value:null},uVel:{value:null},uDims:{value:new W(Gm,Gm)},uSunDir:{value:new G(0,1,0)},uSize:{value:1},uProjScale:{value:1},uMaxPx:{value:qm},uSunColor:{value:new Y(1,1,1)},uSkyColor:{value:new Y(.3,.4,.6)},uOpacity:{value:.55}},transparent:!0,depthTest:!0,depthWrite:!1,blending:5,blendEquation:100,blendSrc:201,blendDst:205,blendSrcAlpha:201,blendDstAlpha:205}),this.points=new na(n,this.material),this.points.frustumCulled=!1,this.points.renderOrder=20,this.points.name=`Spray`,this.points.visible=!1}get capacity(){return this.pass.slots}reset(){this.pass.reset()}count(){return this.active?this.pass.count(this.renderer):{alive:0,crest:0,bow:0}}update(e){let{params:t}=e,n=Du(t.quality),r=e.cascades[0];if(!(t.spray.enabled&&n.spray&&t.foam.enabled&&r?.foam)||!r||!r.foam){this.active&&this.pass.reset(),this.active=!1,this.points.visible=!1;return}this.active=!0;let i=this.tuning,a=Math.min(e.dt,.05),o=t.spray.density,s=e.camera;s.getWorldDirection(this.tmpDir);let c=this.tmpDir.x,l=this.tmpDir.z,u=Math.hypot(c,l)||1,d=[s.position.x+c/u*Km*.45,s.position.z+l/u*Km*.45],f=e.cascades[1],p=t.waves.windDirection,m=null;if(e.bow){let t=Hm(e.bow.speed,o,i),n=Wm(e.bow.samples);if(t>0&&n.length===2){let r=n.find(e=>e.side<0)??n[0],o=n.find(e=>e.side>0)??n[1],s=e=>[e.world.x,Math.max(e.world.y,e.waterY??e.world.y),e.world.z];m={p:Um(t,a,this.pass.slots),a:s(r),b:s(o),forward:[-Math.sin(e.bow.heading),-Math.cos(e.bow.heading)],speed:e.bow.speed,life:i.bowLife}}}let h=this.renderer.getRenderTarget();this.pass.render(this.renderer,{dt:a,cascade0:{displacement:r.displacement,foam:r.foam,jacobian:r.jacobian,size:r.size},cascade1:f&&f.foam?{displacement:f.displacement,foam:f.foam,jacobian:f.jacobian,size:f.size}:null,gravity:i.gravity,dragRate:i.dragRate,windDir:[Math.cos(p),Math.sin(p)],windSpeed:t.waves.windSpeed,windCarry:i.windCarry,foamThreshold:i.foamThreshold,jacThreshold:t.foam.threshold,crestP:i.crestGain*o*a,crestLife:i.crestLife,centre:d,radius:Km,bow:m}),this.renderer.setRenderTarget(h);let g=this.material.uniforms;g.uPos.value=this.pass.positions,g.uVel.value=this.pass.velocities,g.uSize.value=t.spray.size,g.uProjScale.value=e.bufferHeight*s.projectionMatrix.elements[5]/2,g.uSunDir.value.copy(e.sky.sunDirection);let _=t.sky.cloudCoverage;e.sky.sunColor(this.tmpColor).multiplyScalar(t.sun.intensity*(1-.75*_)),g.uSunColor.value.copy(this.tmpColor);let v=e.sky.ambient(this.tmpAmbient);this.tmpColor2.copy(v.sky).lerp(this.tmpColor.setRGB(.5,.5,.5),.35*_),g.uSkyColor.value.copy(this.tmpColor2),this.points.visible=!e.hidden}dispose(){this.pass.dispose(),this.points.geometry.dispose(),this.material.dispose()}};function Zm(e){let t=Math.abs(e);if(t<3){let t=(e/3)**2;return 1-2.2499997*t+1.2656208*t**2-.3163866*t**3+.0444479*t**4-.0039444*t**5+21e-5*t**6}let n=3/t,r=.79788456-77e-8*n-.0055274*n**2-9512e-8*n**3+.00137237*n**4-72805e-8*n**5+14476e-8*n**6,i=t-.78539816-.04166397*n-3954e-8*n**2+.00262573*n**3-54125e-8*n**4-29333e-8*n**5+13558e-8*n**6;return r*Math.cos(i)/Math.sqrt(t)}function Qm(e,t=1,n=.002){let r=8/Math.sqrt(t),i=0;for(let a=n/2;a<r;a+=n)i+=a*a*Math.exp(-t*a*a)*Zm(a*e);return i*n/(2*Math.PI)}function $m(e=6,t=1,n=!1){let r=2*e+1,i=new Float32Array(r*r),a=new Map;for(let n=-e;n<=e;n++)for(let o=-e;o<=e;o++){let s=o*o+n*n,c=a.get(s);c===void 0&&(c=Qm(Math.sqrt(s),t),a.set(s,c)),i[(n+e)*r+(o+e)]=c}if(n){let t=0;for(let e of i)t+=e;let n=(e/2)**2,a=new Float32Array(r*r),o=0;for(let t=-e;t<=e;t++)for(let i=-e;i<=e;i++){let s=Math.exp(-(i*i+t*t)/(2*n));a[(t+e)*r+(i+e)]=s,o+=s}for(let e=0;e<i.length;e++)i[e]=i[e]-t*a[e]/o;let s=e*r+e,c=.012;i[s]=i[s]+c;for(let e of[s-1,s+1,s-r,s+r])i[e]=i[e]-c*.25}return i}var eh=`// iWave wake field (Tessendorf 2004), one explicit step per frame, ping-pong.
...
`,th=6,nh=class{N;size;pingPong;current=0;pass;needsClear=!0;maxStep;constructor(e,t,n=!1,r={}){this.N=e,this.size=t;let a=()=>{let t=Wu(e,2,{linear:n});for(let e of t.textures)e.wrapS=i,e.wrapT=i;return t};this.pingPong=[a(),a()],this.maxStep=r.maxStep??1/40,this.pass=new Uu(eh,{uPrev:{value:null},uN:{value:e},uCell:{value:t/e},uDt:{value:0},uGravity:{value:r.gravity??9.81},uDamping:{value:r.damping??.12},uKernel:{value:Array.from($m(th,1,!0))},uShift:{value:new W(0,0)},uHull:{value:new W(0,0)},uHullFwd:{value:new W(0,-1)},uHullHalf:{value:new W(8,3)},uSpeedFactor:{value:0},uDraft:{value:r.draft??1},uFoamDecay:{value:r.foamDecay??3}})}get cell(){return this.size/this.N}get texture(){return this.target.textures[1]}get target(){return this.pingPong[this.current]}reset(){this.needsClear=!0}readBlock(e,t,n,r,i){let a=e.getRenderTarget(),o=rd(e,this.target,t,n,r,i,1);return e.setRenderTarget(a),o}render(e,t){let n=e.getRenderTarget();if(this.needsClear){for(let t of this.pingPong)e.setRenderTarget(t),e.setClearColor(0,0),e.clear(!0,!1,!1);this.needsClear=!1}let r=this.pass.uniforms;r.uHull.value.set(t.hull[0],t.hull[1]),r.uHullFwd.value.set(t.forward[0],t.forward[1]),r.uHullHalf.value.set(t.halfSize[0],t.halfSize[1]),r.uSpeedFactor.value=t.speedFactor;let i=Math.min(t.dt,.1),a=Math.max(1,Math.ceil(i/this.maxStep)),o=i/a;for(let n=0;n<a;n++){let i=this.pingPong[this.current],a=this.pingPong[this.current^1];r.uPrev.value=i.textures[0],r.uDt.value=o,n===0?r.uShift.value.set(t.shift[0],t.shift[1]):r.uShift.value.set(0,0),this.pass.render(e,a),this.current^=1}e.setRenderTarget(n)}dispose(){this.pass.dispose(),this.pingPong[0].dispose(),this.pingPong[1].dispose()}};function rh(e=0,t=0,n=0){return{x:e,y:t,z:n}}function ih(){return{x:0,y:0,z:0,w:1}}function ah(e,t){let n=Math.sin(t/2);return{x:e.x*n,y:e.y*n,z:e.z*n,w:Math.cos(t/2)}}function oh(e,t){return{x:e.w*t.x+e.x*t.w+e.y*t.z-e.z*t.y,y:e.w*t.y-e.x*t.z+e.y*t.w+e.z*t.x,z:e.w*t.z+e.x*t.y-e.y*t.x+e.z*t.w,w:e.w*t.w-e.x*t.x-e.y*t.y-e.z*t.z}}function sh(e,t){let n=2*(e.y*t.z-e.z*t.y),r=2*(e.z*t.x-e.x*t.z),i=2*(e.x*t.y-e.y*t.x);return{x:t.x+e.w*n+(e.y*i-e.z*r),y:t.y+e.w*r+(e.z*n-e.x*i),z:t.z+e.w*i+(e.x*r-e.y*n)}}function ch(e,t){return sh({x:-e.x,y:-e.y,z:-e.z,w:e.w},t)}function lh(e,t){return{x:e.y*t.z-e.z*t.y,y:e.z*t.x-e.x*t.z,z:e.x*t.y-e.y*t.x}}function uh(e,t){return e.x*t.x+e.y*t.y+e.z*t.z}function dh(e){let t=sh(e,rh(0,0,-1)),n=sh(e,rh(1,0,0)),r=Math.atan2(-t.x,-t.z),i=Math.asin(Math.max(-1,Math.min(1,t.y))),a=rh(Math.cos(r),0,-Math.sin(r)),o=lh(a,t);return{yaw:r,pitch:i,roll:Math.atan2(-uh(n,o),uh(n,a))}}function fh(e,t,n,r){let i=e/12;return{x:i*(n*n+r*r),y:i*(t*t+r*r),z:i*(t*t+n*n)}}var ph=class{mass;inertia;linearDrag;angularDrag;position=rh();orientation=ih();velocity=rh();angularVelocity=rh();force=rh();torque=rh();constructor(e){if(!(e.mass>0))throw RangeError(`RigidBody: mass must be positive`);this.mass=e.mass,this.inertia={...e.inertia},this.linearDrag=e.linearDrag??0,this.angularDrag=e.angularDrag??0}applyForce(e){this.force.x+=e.x,this.force.y+=e.y,this.force.z+=e.z}applyTorque(e){this.torque.x+=e.x,this.torque.y+=e.y,this.torque.z+=e.z}applyForceAt(e,t){this.applyForce(e);let n=rh(t.x-this.position.x,t.y-this.position.y,t.z-this.position.z);this.applyTorque(lh(n,e))}localToWorld(e){let t=sh(this.orientation,e);return rh(t.x+this.position.x,t.y+this.position.y,t.z+this.position.z)}worldToLocal(e){return ch(this.orientation,rh(e.x-this.position.x,e.y-this.position.y,e.z-this.position.z))}localToWorldDir(e){return sh(this.orientation,e)}worldToLocalDir(e){return ch(this.orientation,e)}velocityAt(e){let t=rh(e.x-this.position.x,e.y-this.position.y,e.z-this.position.z),n=lh(this.angularVelocity,t);return rh(this.velocity.x+n.x,this.velocity.y+n.y,this.velocity.z+n.z)}kineticEnergy(){let e=this.velocity,t=ch(this.orientation,this.angularVelocity),n=this.inertia;return .5*this.mass*uh(e,e)+.5*(n.x*t.x*t.x+n.y*t.y*t.y+n.z*t.z*t.z)}integrate(e){if(!(e>0)){this.clear();return}let t=this.velocity,n=1/this.mass;t.x+=this.force.x*n*e,t.y+=this.force.y*n*e,t.z+=this.force.z*n*e;let r=this.orientation,i=ch(r,this.torque),a=this.inertia,o=sh(r,rh(i.x/a.x,i.y/a.y,i.z/a.z)),s=this.angularVelocity;if(s.x+=o.x*e,s.y+=o.y*e,s.z+=o.z*e,this.linearDrag>0){let n=Math.exp(-this.linearDrag*e);t.x*=n,t.y*=n,t.z*=n}if(this.angularDrag>0){let t=Math.exp(-this.angularDrag*e);s.x*=t,s.y*=t,s.z*=t}let c=this.position;c.x+=t.x*e,c.y+=t.y*e,c.z+=t.z*e;let l=oh({x:s.x,y:s.y,z:s.z,w:0},r);r.x+=.5*l.x*e,r.y+=.5*l.y*e,r.z+=.5*l.z*e,r.w+=.5*l.w*e;let u=Math.hypot(r.x,r.y,r.z,r.w)||1;r.x/=u,r.y/=u,r.z/=u,r.w/=u,this.clear()}clear(){this.force.x=this.force.y=this.force.z=0,this.torque.x=this.torque.y=this.torque.z=0}reset(e,t=0){this.position.x=e.x,this.position.y=e.y,this.position.z=e.z;let n=ah(rh(0,1,0),t);this.orientation.x=n.x,this.orientation.y=n.y,this.orientation.z=n.z,this.orientation.w=n.w,this.velocity.x=this.velocity.y=this.velocity.z=0,this.angularVelocity.x=this.angularVelocity.y=this.angularVelocity.z=0,this.clear()}};function mh(e){if(e<.45)return .62+.38*Math.sin(Math.PI/2*e/.45);let t=(e-.45)/.55;return Math.max(.02,Math.cos(Math.PI/2*t)**.7)}function hh(e){let t=.85+.15*Math.min(1,e/.3),n=e>.6?1-.45*((e-.6)/.4)**2:1;return Math.min(t,n)}function gh(e){return 3.1+4.5*(e-.42)*(e-.42)}var _h=1.25;function vh(e){return Math.sqrt(Math.max(0,1-(1-e)*(1-e)))*(1-.14*Math.max(0,(e-.68)/.32))}var yh=9.81,bh=1/60,xh=[.4,.2,0,-.2,-.4],Sh=.8,Ch=.55,wh=class e{static LENGTH=40;static BEAM=10;static DRAFT=3;static CRUISE=7;body;samples;dims;footprintRadius;originShiftZ;throttle=0;rudder=0;rho;heaveDamping;thrust;dragForward;dragLateral;yawTorque;yawDamping;rollPitchDamping;cruise;constructor(t={}){let n=t.length??e.LENGTH,r=t.beam??e.BEAM,i=t.draft??e.DRAFT;this.dims={length:n,beam:r,draft:i},this.rho=t.rho??1e3,this.cruise=t.cruise??e.CRUISE;let a=.7*n*r,o=[];for(let e=0;e<5;e++){let t=xh[e]*n,a=.5-xh[e],s=mh(a),c=i*hh(a);o.push({local:rh(0,-c,t),weight:s,draft:c});for(let e of[-1,1])o.push({local:rh(e*Sh*s*(r/2),-c*Ch,t),weight:s*.85,draft:c*Ch})}let s=o.reduce((e,t)=>e+t.weight,0),c=o.reduce((e,t)=>e+t.weight*t.draft,0);this.originShiftZ=o.reduce((e,t)=>e+t.weight*t.draft*t.local.z,0)/c;for(let e of o)e.local.z-=this.originShiftZ;this.samples=o.map(e=>({local:e.local,area:a*e.weight/s,draft:e.draft,height:i*2.5,world:rh(),waterY:0,depth:0,force:0})),this.footprintRadius=Math.hypot(.4*n,r/2)+1;let l=this.rho*this.samples.reduce((e,t)=>e+t.area*t.draft,0),u=fh(l,r,i*2.5,n*.9);this.body=new ph({mass:l,inertia:u,linearDrag:.02,angularDrag:0});let d=this.rho*yh*a,f=Math.sqrt(d/l);this.heaveDamping=2*(t.damping??.7)*l*f;let p=t.acceleration??1.6;this.thrust=l*p,this.dragForward=this.thrust/(this.cruise*this.cruise),this.dragLateral=this.dragForward*25;let m=t.yawRate??.4;this.yawDamping=u.y*1.2,this.yawTorque=this.yawDamping*m,this.rollPitchDamping=.25}get mass(){return this.body.mass}get heading(){return dh(this.body.orientation).yaw}get pitch(){return dh(this.body.orientation).pitch}get roll(){return dh(this.body.orientation).roll}get speed(){let e=this.body.localToWorldDir(rh(0,0,-1)),t=this.body.velocity;return e.x*t.x+e.y*t.y+e.z*t.z}reset(e,t,n,r=0){this.body.reset(rh(e,t,n),r),this.throttle=0,this.rudder=0,this.refreshSamples()}refreshSamples(){for(let e of this.samples){let t=this.body.localToWorld(e.local);e.world.x=t.x,e.world.y=t.y,e.world.z=t.z}}step(e,t){if(!(e>0))return;this.refreshSamples();for(let e of this.samples)e.waterY=t.heightAt(e.world.x,e.world.z);let n=Math.max(1,Math.ceil(e/bh)),r=e/n;for(let e=0;e<n;e++)this.substep(r)}substep(e){let t=this.body,n=this.rho;t.applyForce(rh(0,-t.mass*yh,0));let r=this.samples.reduce((e,t)=>e+t.area,0);for(let e of this.samples){let i=t.localToWorld(e.local);e.world.x=i.x,e.world.y=i.y,e.world.z=i.z;let a=Math.min(e.height,Math.max(0,e.waterY-i.y));e.depth=a;let o=n*yh*e.area*a;if(a>0){let n=t.velocityAt(i).y,s=this.heaveDamping*e.area/r;o-=s*n*Math.min(1,a/.5)}e.force=o,o!==0&&t.applyForceAt(rh(0,o,0),i)}let i=t.worldToLocalDir(t.velocity),a=-i.z,o=Th(this.throttle,-1,1),s=-((o>=0?o*this.thrust:o*this.thrust*.4)-this.dragForward*a*Math.abs(a)),c=-this.dragLateral*i.x*Math.abs(i.x);t.applyForce(t.localToWorldDir(rh(c,0,s)));let l=t.worldToLocalDir(t.angularVelocity),u=t.inertia,d=Th(this.rudder,-1,1)*this.yawTorque*Th(a/this.cruise,-1,1)-this.yawDamping*l.y,f=-this.rollPitchDamping*u.x*l.x,p=-this.rollPitchDamping*u.z*l.z;t.applyTorque(t.localToWorldDir(rh(f,d,p))),t.integrate(e)}};function Th(e,t,n){return e<t?t:e>n?n:e}var Eh=512,Dh=512,Oh=4,kh=`
precision highp float;
in vec3 position;
in vec2 uv;
uniform mat4 projectionMatrix;
...
void main() {
  ...
  fragColor = vec4(c, a);
}`,jh=class{renderer;pass;debug=new Dn;ring;plane;planeMat;originX=NaN;originZ=NaN;hullX=0;hullZ=0;constructor(e){this.renderer=e,this.pass=new nh(Eh,Dh,Ku(e)),this.ring=new oi(new ga(2.2,.12,6,40),new Jr({color:3401471,depthTest:!1})),this.ring.rotation.x=Math.PI/2,this.ring.renderOrder=10,this.planeMat=new Ea({glslVersion:Ke,vertexShader:kh,fragmentShader:Ah,uniforms:{uWake:{value:null}},transparent:!0,depthWrite:!1,depthTest:!1,side:2}),this.plane=new oi(new ma(Dh,Dh),this.planeMat),this.plane.rotation.x=-Math.PI/2,this.plane.renderOrder=9,this.debug.add(this.ring,this.plane),this.debug.visible=!1,this.debug.name=`WakeProbes`}get cell(){return this.pass.cell}get origin(){return[this.originX,this.originZ]}get size(){return Dh}get texture(){return this.pass.texture}reset(){this.pass.reset(),this.originX=NaN,this.originZ=NaN}update(e,t,n=0){let r=this.cell,i=Math.floor((t.x-Dh/2)/r)*r,a=Math.floor((t.z-Dh/2)/r)*r,o=Number.isNaN(this.originX)?[0,0]:[Math.round((i-this.originX)/r),Math.round((a-this.originZ)/r)];this.originX=i,this.originZ=a,this.hullX=t.x,this.hullZ=t.z;let s=[-Math.sin(t.heading),-Math.cos(t.heading)],c=Math.min(1,Math.abs(t.speed)/wh.CRUISE);this.pass.render(this.renderer,{dt:e,shift:o,hull:[(t.x-i)/r,(t.z-a)/r],forward:t.speed<0?[-s[0],-s[1]]:s,halfSize:[t.length*.5/r,t.beam*.5/r],speedFactor:c}),this.debug.visible&&(this.ring.position.set(t.x,n+.4,t.z),this.plane.position.set(i+Dh/2,n+.6,a+Dh/2),this.planeMat.uniforms.uWake.value=this.pass.texture)}sample(e,t){if(Number.isNaN(this.originX))return{height:0,foam:0};let n=this.cell,r=Math.floor((this.hullX+e-this.originX)/n)-1,i=Math.floor((this.hullZ+t-this.originZ)/n)-1;if(r<0||i<0||r+Oh>Eh||i+Oh>Eh)return{height:0,foam:0};let a=this.pass.readBlock(this.renderer,r,i,Oh,Oh),o=0,s=0;for(let e=0;e<a.length;e+=4){let t=a[e];Math.abs(t)>Math.abs(o)&&(o=t),s=Math.max(s,a[e+3])}return{height:o,foam:s}}dispose(){this.pass.dispose(),this.ring.geometry.dispose(),this.ring.material.dispose(),this.plane.geometry.dispose(),this.planeMat.dispose()}},Mh={type:`change`},Nh={type:`start`},Ph={type:`end`},Fh=new qr,Ih=new Br,Lh=Math.cos(70*At.DEG2RAD),Rh=new G,zh=2*Math.PI,Bh={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Vh=1e-6,Hh=class extends as{constructor(n,r=null){super(n,r),this.state=Bh.NONE,this.target=new G,this.cursor=new G,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:e.ROTATE,MIDDLE:e.DOLLY,RIGHT:e.PAN},this.touches={ONE:t.ROTATE,TWO:t.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new G,this._lastQuaternion=new jt,this._lastTargetPosition=new G,this._quat=new jt().setFromUnitVectors(n.up,new G(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new es,this._sphericalDelta=new es,this._scale=1,this._panOffset=new G,this._rotateStart=new W,this._rotateEnd=new W,this._rotateDelta=new W,this._panStart=new W,this._panEnd=new W,this._panDelta=new W,this._dollyStart=new W,this._dollyEnd=new W,this._dollyDelta=new W,this._dollyDirection=new G,this._mouse=new W,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Wh.bind(this),this._onPointerDown=Uh.bind(this),this._onPointerUp=Gh.bind(this),this._onContextMenu=Qh.bind(this),this._onMouseWheel=Jh.bind(this),this._onKeyDown=Yh.bind(this),this._onTouchStart=Xh.bind(this),this._onTouchMove=Zh.bind(this),this._onMouseDown=Kh.bind(this),this._onMouseMove=qh.bind(this),this._interceptControlDown=$h.bind(this),this._interceptControlUp=eg.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.state=Bh.NONE,this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents();let e=this.domElement.getRootNode();e.removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),e.removeEventListener(`keyup`,this._interceptControlUp,{capture:!0}),this._controlActive=!1,this._pointers.length=0,this._pointerPositions={},this.domElement.style.touchAction=``,this.domElement.style.cursor=`auto`}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Mh),this.update(),this.state=Bh.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;Rh.copy(t).sub(this.target),Rh.applyQuaternion(this._quat),this._spherical.setFromVector3(Rh),this.autoRotate&&this.state===Bh.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=zh:n>Math.PI&&(n-=zh),r<-Math.PI?r+=zh:r>Math.PI&&(r-=zh),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(Rh.setFromSpherical(this._spherical),Rh.applyQuaternion(this._quatInverse),t.copy(this.target).add(Rh),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=Rh.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new G(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new G(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=Rh.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(Fh.origin.copy(this.object.position),Fh.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Fh.direction))<Lh?this.object.lookAt(this.target):(Ih.setFromNormalAndCoplanarPoint(this.object.up,this.target),Fh.intersectPlane(Ih,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>Vh||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Vh||this._lastTargetPosition.distanceToSquared(this.target)>Vh?(this.dispatchEvent(Mh),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?zh/60/60*this.autoRotateSpeed:zh/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){Rh.setFromMatrixColumn(t,0),Rh.multiplyScalar(-e),this._panOffset.add(Rh)}_panUp(e,t){this.screenSpacePanning===!0?Rh.setFromMatrixColumn(t,1):(Rh.setFromMatrixColumn(t,0),Rh.crossVectors(this.object.up,Rh)),Rh.multiplyScalar(e),this._panOffset.add(Rh)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;Rh.copy(r).sub(this.target);let i=Rh.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(zh*this._rotateDelta.x/t.clientHeight),this._rotateUp(zh*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(zh*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-zh*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(zh*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-zh*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(zh*this._rotateDelta.x/t.clientHeight),this._rotateUp(zh*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new W,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function Uh(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function Wh(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function Gh(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(Ph),this.state=Bh.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y})}}function Kh(t){let n;switch(t.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case e.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(t),this.state=Bh.DOLLY;break;case e.ROTATE:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=Bh.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=Bh.ROTATE}break;case e.PAN:if(t.ctrlKey||t.metaKey||t.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(t),this.state=Bh.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(t),this.state=Bh.PAN}break;default:this.state=Bh.NONE}this.state!==Bh.NONE&&this.dispatchEvent(Nh)}function qh(e){switch(this.state){case Bh.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case Bh.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case Bh.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e)}}function Jh(e){this.enabled!==!1&&this.enableZoom!==!1&&this.state===Bh.NONE&&(e.preventDefault(),this.dispatchEvent(Nh),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(Ph))}function Yh(e){this.enabled!==!1&&this._handleKeyDown(e)}function Xh(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case t.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=Bh.TOUCH_ROTATE;break;case t.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=Bh.TOUCH_PAN;break;default:this.state=Bh.NONE}break;case 2:switch(this.touches.TWO){case t.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=Bh.TOUCH_DOLLY_PAN;break;case t.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=Bh.TOUCH_DOLLY_ROTATE;break;default:this.state=Bh.NONE}break;default:this.state=Bh.NONE}this.state!==Bh.NONE&&this.dispatchEvent(Nh)}function Zh(e){switch(this._trackPointer(e),this.state){case Bh.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case Bh.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case Bh.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case Bh.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=Bh.NONE}}function Qh(e){this.enabled!==!1&&e.preventDefault()}function $h(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function eg(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}var tg=10,ng=8,rg=class extends Dn{discs=[];arrows=[];discGeo=new la(.7,16);discMat=new Jr({color:3530858,transparent:!0,opacity:.85,depthTest:!1,side:2});hull;constructor(e){super(),this.hull=e,this.name=`BuoyancyProbes`,this.visible=!1;for(let t=0;t<e.samples.length;t++){let e=new oi(this.discGeo,this.discMat);e.rotation.x=-Math.PI/2,e.renderOrder=11,this.discs.push(e);let t=new is(new G(0,1,0),new G,1,16765503,.6,.4);t.renderOrder=12,t.line.material.depthTest=!1,t.cone.material.depthTest=!1,this.arrows.push(t),this.add(e,t)}}setHull(e){if(e.samples.length!==this.discs.length)throw Error(`ProbesOverlay.setHull: sample count changed`);this.hull=e}update(){this.visible&&this.hull.samples.forEach((e,t)=>{this.discs[t].position.set(e.world.x,e.waterY+.05,e.world.z);let n=this.arrows[t];n.position.set(e.world.x,e.world.y,e.world.z);let r=Math.min(ng,Math.abs(e.force)/1e6*tg);n.setDirection(new G(0,e.force>=0?1:-1,0)),n.setLength(Math.max(.05,r),.6,.4),n.visible=r>.05})}dispose(){this.discGeo.dispose(),this.discMat.dispose();for(let e of this.arrows)e.dispose()}},ig=22,ag=14,og=4,sg=10,cg=class extends Dn{length;beam;draft;mats;geometries=[];constructor(e={}){super(),this.name=`Ship`,this.length=e.length??40,this.beam=e.beam??10,this.draft=e.draft??3,this.mats=e.materials??gm(),this.buildHull(),this.buildDecks(),this.buildRig(),this.traverse(e=>{(e instanceof oi||e instanceof Yi)&&(e.userData.castsWaterDepth=!0,e.castShadow=!0,e.receiveShadow=!0)})}stationZ(e){return this.length/2-e*this.length}keep(e){return this.geometries.push(e),e}mesh(e,t,n){let r=new oi(this.keep(e),t);return r.name=n,this.add(r),r}hullPoint(e,t,n,r){let i=this.beam/2*mh(e),a=-this.draft*hh(e),o=gh(e)+_h;return r.set(n*i*vh(t),a+(o-a)*t,this.stationZ(e))}buildHull(){let e=[],t=[],n=[],r=[],i=new G,a=new G;for(let n=0;n<=ig;n++){let r=n/ig,o=0;for(let n=0;n<29;n++){let s=n<ag?-1:1,c=Math.abs(n-ag)/ag;this.hullPoint(r,c,s,i),n>0&&(o+=i.distanceTo(a)),a.copy(i),e.push(i.x,i.y,i.z),t.push(i.z/og,o/og)}}for(let t=0;t<ig;t++)for(let i=0;i<28;i++){let a=t*29+i,o=a+1,s=a+29,c=s+1;((e[a*3+1]+e[o*3+1]+e[s*3+1]+e[c*3+1])/4<.2?r:n).push(a,s,o,o,s,c)}let o=e.length/3,s=(gh(0)+_h-this.draft*hh(0))/2;e.push(0,s,this.stationZ(0)),t.push(0,s/og);for(let e=0;e<28;e++)n.push(o,e+1,e);let c=new Nr;c.setAttribute(`position`,new X(e,3)),c.setAttribute(`uv`,new X(t,2)),c.setIndex([...r,...n]),c.addGroup(0,r.length,0),c.addGroup(r.length,n.length,1),c.computeVertexNormals(),this.mesh(c,[this.mats.hullBelow,this.mats.hull],`hull`),this.strake(.5,.14,.45,this.mats.wale,`wale-lower`),this.strake(.7,.14,.4,this.mats.wale,`wale-upper`),this.strake(.86,.1,.32,this.mats.wale,`wale-rail`),this.strake(.79,.04,.16,this.mats.gilt,`gilt-band`),this.mesh(new ca(.5,.6,this.length*.78),this.mats.wale,`keel`).position.set(0,-this.draft-.1,this.length*.03);let l=this.mesh(new ca(.5,gh(1)+_h+this.draft*.7,1.2),this.mats.wale,`stem`);l.position.set(0,(gh(1)+_h-this.draft*.7)/2,this.stationZ(1)+.2),l.rotation.x=.28,this.mesh(new ca(.35,this.draft*.85+1.5,1.4),this.mats.wale,`rudder`).position.set(0,-this.draft*.85*.5+.5,this.stationZ(0)+.6)}strake(e,t,n,r,i){let a=[],o=[],s=[],c=new G,l=new G,u=new G,d=new G;for(let r of[-1,1]){let i=a.length/3;for(let i=0;i<23;i++){let s=.02+.965*i/22;this.hullPoint(s,e,r,c),this.hullPoint(s,Math.min(1,e+.02),r,u),l.set(u.y-c.y,-(u.x-c.x),0).normalize(),l.x*r<0&&l.negate(),d.copy(c).addScaledVector(l,t),a.push(c.x,c.y-n/2,c.z,d.x,d.y-n/2,d.z,d.x,d.y+n/2,d.z,c.x,c.y+n/2,c.z);for(let e=0;e<4;e++)o.push(c.z/og,e/40)}for(let e=0;e<22;e++){let t=i+e*4,n=t+4;for(let e=0;e<3;e++)r>0?s.push(t+e,n+e,t+e+1,t+e+1,n+e,n+e+1):s.push(t+e,t+e+1,n+e,t+e+1,n+e+1,n+e)}}let f=new Nr;f.setAttribute(`position`,new X(a,3)),f.setAttribute(`uv`,new X(o,2)),f.setIndex(s),f.computeVertexNormals(),this.mesh(f,r,i)}deckStrip(e,t,n,r=.35,i=`deck`){let a=this.beam/2,o=Math.max(2,Math.round((t-e)*ig)+1),s=[],c=[],l=[];for(let i=0;i<o;i++){let l=e+(t-e)*i/(o-1),u=Math.max(.05,a*mh(l)*vh(1)-r),d=gh(l)+n,f=this.stationZ(l);s.push(-u,d,f,0,d+.12,f,u,d,f),c.push(f/og,-u/og,f/og,0,f/og,u/og)}for(let e=0;e<o-1;e++){let t=e*3,n=t+3;l.push(t,t+1,n,n,t+1,n+1,t+1,t+2,n+1,n+1,t+2,n+2)}let u=new Nr;return u.setAttribute(`position`,new X(s,3)),u.setAttribute(`uv`,new X(c,2)),u.setIndex(l),u.computeVertexNormals(),this.mesh(u,this.mats.deck,i)}castleBlock(e,t,n,r){let i=this.beam/2,a=Math.max(2,Math.round((t-e)*ig)+1),o=[],s=[],c=[];for(let r=0;r<a;r++){let c=e+(t-e)*r/(a-1),l=Math.max(.05,i*mh(c)*vh(1)-.3),u=gh(c)-.4,d=gh(c)+n,f=this.stationZ(c);o.push(-l,u,f,-l,d,f,l,d,f,l,u,f),s.push(f/og,u/og,f/og,d/og,f/og,d/og+.5,f/og,u/og+.5)}for(let e=0;e<a-1;e++){let t=e*4,n=t+4;for(let e=0;e<3;e++)c.push(t+e,n+e,t+e+1,t+e+1,n+e,n+e+1)}c.push(0,1,2,0,2,3);let l=(a-1)*4;c.push(l,l+2,l+1,l,l+3,l+2);let u=new Nr;return u.setAttribute(`position`,new X(o,3)),u.setAttribute(`uv`,new X(s,2)),u.setIndex(c),u.computeVertexNormals(),this.mesh(u,r,`castle`)}cornice(e,t,n,r){let i=this.beam/2,a=Math.max(2,Math.round((t-e)*ig)+1),o=[],s=[];for(let r=0;r<a;r++){let s=e+(t-e)*r/(a-1),c=Math.max(.05,i*mh(s)*vh(1)-.2),l=gh(s)+n,u=this.stationZ(s);for(let e of[-1,1])o.push(e*c,l,u,e*c,l+.9,u,e*(c-.25),l+.9,u)}for(let e=0;e<a-1;e++){let t=e*6,n=t+6;for(let e of[0,3])s.push(t+e,n+e,t+e+1,t+e+1,n+e,n+e+1,t+e+1,n+e+1,t+e+2,t+e+2,n+e+1,n+e+2)}let c=new Nr;return c.setAttribute(`position`,new X(o,3)),c.setIndex(s),c.computeVertexNormals(),this.mesh(c,r,`cornice`)}buildDecks(){this.deckStrip(.02,.98,-.05);for(let[e,t,n]of[[0,.36,2.3],[0,.18,4.3]])this.castleBlock(e,t,n,this.mats.hull),this.deckStrip(e+.01,t,n,.32,`castle-deck`),this.cornice(e,t,n+.05,this.mats.gilt);for(let e=0;e<7;e++){let t=.2+e*.09,n=this.beam/2*mh(t)*vh(.72),r=gh(t)-1;for(let e of[-1,1]){this.mesh(new ca(.12,.9,1),this.mats.wale,`gunport`).position.set(e*(n+.02),r,this.stationZ(t));let i=this.mesh(new ua(.16,.18,.8,8),this.mats.iron,`cannon`);i.rotation.z=Math.PI/2,i.position.set(e*(n+.25),r,this.stationZ(t))}}let e=this.stationZ(.02)+.05,t=this.beam/2*mh(.02)*vh(1)-.9;for(let n=0;n<5;n++){let r=-t+n/4*2*t;this.mesh(new ca(.9,1.1,.1),this.mats.glass,`window`).position.set(r,gh(.02)+1.3,e),this.mesh(new ca(1.1,1.3,.08),this.mats.gilt,`window-frame`).position.set(r,gh(.02)+1.3,e-.02)}this.mesh(new ha(.4,10,8),new Da({color:16765562,emissive:16757575,emissiveIntensity:1.2,roughness:.4}),`lantern`).position.set(0,gh(.02)+4.3+1.6,this.stationZ(0)-.4),this.castleBlock(.76,.97,1.6,this.mats.hull),this.deckStrip(.76,.96,1.6,.32,`forecastle-deck`),this.cornice(.76,.96,1.65,this.mats.gilt)}spar(e,t,n){return this.mesh(new ua(e,t,n,10),this.mats.spar,`spar`)}sail(e,t,n){let r=new ma(e,t,14,10),i=r.attributes.position,a=r.attributes.uv;for(let r=0;r<i.count;r++){let o=At.clamp(i.getX(r)/e+.5,0,1),s=At.clamp(i.getY(r)/t+.5,0,1),c=Math.sin(o*Math.PI),l=Math.sin((1-s)*Math.PI*.5)**.8;i.setZ(r,-n*c*(.35+.65*l)),i.setY(r,i.getY(r)-.25*t*(1-s)*(1-c)*.3),a.setXY(r,o*e/sg,s*t/sg)}r.computeVertexNormals();let o=this.mesh(r,this.mats.sail,`sail`),s=[];for(let e of[2,3]){let t=[];for(let n=0;n<=14;n++){let r=e*15+n;t.push(new G(i.getX(r),i.getY(r),i.getZ(r)-.06))}s.push(t)}return{mesh:o,reefs:s}}buildRig(){let e=[],t=this.beam/2,n=(t,n)=>{e.push(t.x,t.y,t.z,n.x,n.y,n.z)},r=[{t:.74,height:26,yards:[.56,.42]},{t:.47,height:32,yards:[.58,.44]},{t:.2,height:22,yards:[.42]}],i=[];r.forEach((e,r)=>{let a=this.stationZ(e.t),o=gh(e.t)+(r===2?2.3:r===0?1.6:0)-.3;this.spar(.16,.38,e.height+1).position.set(0,o+(e.height+1)/2-1,a);let s=o+e.height;i.push(new G(0,s,a));let c=o+e.height*.58;this.mesh(new ua(1.1,.9,.3,12),this.mats.spar,`top`).position.set(0,c,a);let l=[.36,.7];e.yards.forEach((i,s)=>{let c=i*e.height,u=o+e.height*l[s],d=this.spar(.12,.12,c);if(d.rotation.z=Math.PI/2,d.position.set(0,u,a-.5),r<2){let r=s===0?e.height*.24:e.height*.2,{mesh:i,reefs:d}=this.sail(c*.96,r,c*.14);i.position.set(0,u-r/2,a-.7);for(let e of d){for(let t=0;t+1<e.length;t++)n(e[t].clone().add(i.position),e[t+1].clone().add(i.position));for(let t=1;t<e.length;t+=2){let r=e[t].clone().add(i.position);n(r,r.clone().setY(r.y-.6))}}for(let i of[-1,1]){let d=new G(i*c*.96/2,u-r,a-.7),f=s===0?new G(i*(t*mh(e.t)-.5),o+1.2,a+3):new G(i*e.yards[0]*e.height/2,o+e.height*l[0],a-.5);n(d,f)}}for(let t of[-1,1])n(new G(t*c/2,u,a-.5),new G(0,u+e.height*.2,a))});for(let r of[-1,1]){let i=[],o=new G(r*.3,c-.2,a);for(let s=-1;s<=1;s++){let c=new G(r*(t*mh(e.t+s*.03)*.96),gh(e.t)+_h,a+s*1.6);n(o,c),i.push(c)}let s=o.y-i[1].y;for(let e=1.2;e<s-1.5;e+=1.1){let t=e/s;n(i[0].clone().lerp(o,t),i[2].clone().lerp(o,t))}}if(r===1){let e=this.mesh(new ma(4.5,1.6,6,1),this.mats.flag,`flag`);e.position.set(0,s+.4,a+2.3),e.rotation.y=Math.PI/2}});let a=this.stationZ(1),o=this.spar(.12,.3,13),s=.32;o.rotation.x=-Math.PI/2+s;let c=new G(0,gh(.98)+1.6,a+2.5),l=new G(0,Math.sin(s),-Math.cos(s));o.position.copy(c).addScaledVector(l,13/2);let u=c.clone().addScaledVector(l,12.35);n(i[0],u),n(i[0].clone().setY(i[0].y*.6),u.clone().addScaledVector(l,-4)),n(i[1],i[0].clone().setY(i[0].y*.62)),n(i[2],i[1].clone().setY(i[1].y*.6)),n(i[1],new G(0,gh(.05)+4.3,this.stationZ(.06)));let d=this.keep(new Nr);d.setAttribute(`position`,new X(e,3));let f=new Yi(d,this.mats.ropeLine);f.name=`rigging`,this.add(f)}dispose(){for(let e of this.geometries)e.dispose()}},lg=class extends Dn{static CRUISE=wh.CRUISE;physics=new wh;model;modelKind=`procedural`;disposeModel;probes;constructor(){super(),this.name=`Ship`;let{length:e,beam:t,draft:n}=this.physics.dims,r=new cg({length:e,beam:t,draft:n});this.model=r,this.disposeModel=()=>r.dispose(),this.model.position.z=-this.physics.originShiftZ,this.add(this.model),this.probes=new rg(this.physics),this.sync()}get length(){return this.physics.dims.length}get beam(){return this.physics.dims.beam}get heading(){return this.physics.heading}get speed(){return this.physics.speed}get pitch(){return this.physics.pitch}get roll(){return this.physics.roll}get samples(){return this.physics.samples}setModel(e,t,n,r=()=>{}){let i=this.physics,a=i.body.position;this.remove(this.model),this.disposeModel(),this.model=e,this.modelKind=n,this.disposeModel=r,this.physics=new wh(t),this.physics.reset(a.x,a.y,a.z,i.heading),this.probes.setHull(this.physics),this.model.position.z=-this.physics.originShiftZ,this.add(this.model),this.sync()}reset(e,t,n,r=0){this.physics.reset(e,t,n,r),this.sync()}update(e,t,n,r){this.physics.throttle=t,this.physics.rudder=n,this.physics.step(e,r),this.sync(),this.probes.update()}sync(){let e=this.physics.body;this.position.set(e.position.x,e.position.y,e.position.z),this.quaternion.set(e.orientation.x,e.orientation.y,e.orientation.z,e.orientation.w)}dispose(){this.disposeModel(),this.probes.dispose()}},ug={orbit:1,fly:2,boat:3},dg=class{down=new Set;constructor(e){e.addEventListener(`keydown`,e=>{fg(e)||this.down.add(e.key.toLowerCase())}),e.addEventListener(`keyup`,e=>this.down.delete(e.key.toLowerCase())),e.addEventListener(`blur`,()=>this.down.clear())}has(e){return this.down.has(e)}};function fg(e){let t=e.target;return!!t&&(t.tagName===`INPUT`||t.tagName===`SELECT`||t.tagName===`TEXTAREA`)}var pg=class e{dom;water;camera;hull=new lg;static DROP_HEIGHT=2;mode=`orbit`;orbit;keys;yaw=0;pitch=0;dragging=!1;lastX=0;lastY=0;modeListeners=[];lastWaterHeight=0;lookTarget=new G;tmpEuler=new ln;tmpFwd=new G;tmpRight=new G;constructor(e,t,n){this.dom=e,this.water=n,this.camera=new Eo(55,t,.5,4e4),this.camera.position.set(0,14,46),this.keys=new dg(window),this.orbit=new Hh(this.camera,e),this.orbit.target.set(0,2,0),this.orbit.enableDamping=!0,this.orbit.dampingFactor=.08,this.orbit.minDistance=4,this.orbit.maxDistance=600,this.orbit.maxPolarAngle=Math.PI*.49,this.orbit.update(),this.hull.visible=!1,e.addEventListener(`pointerdown`,t=>{this.mode===`fly`&&(this.dragging=!0,this.lastX=t.clientX,this.lastY=t.clientY,e.setPointerCapture?.(t.pointerId))}),e.addEventListener(`pointermove`,e=>{if(!this.dragging||this.mode!==`fly`)return;let t=e.clientX-this.lastX,n=e.clientY-this.lastY;this.lastX=e.clientX,this.lastY=e.clientY,this.yaw-=t*.003,this.pitch=At.clamp(this.pitch-n*.003,-1.4,1.4)});let r=()=>{this.dragging=!1};e.addEventListener(`pointerup`,r),e.addEventListener(`pointercancel`,r),e.addEventListener(`contextmenu`,e=>e.preventDefault()),window.addEventListener(`keydown`,e=>{fg(e)||(e.key===`1`?this.setMode(`orbit`):e.key===`2`?this.setMode(`fly`):e.key===`3`&&this.setMode(`boat`))})}onModeChange(e){this.modeListeners.push(e)}setMode(t){if(t!==this.mode){if(this.mode=t,this.orbit.enabled=t===`orbit`,this.hull.visible=t===`boat`,t===`fly`){let e=this.camera.getWorldDirection(new G);this.yaw=Math.atan2(-e.x,-e.z),this.pitch=Math.asin(At.clamp(e.y,-1,1))}else if(t===`boat`)this.hull.reset(0,this.water.heightAt(0,0)+e.DROP_HEIGHT,0,0),this.camera.position.set(30,22,55),this.lookTarget.set(0,8,0);else{this.orbit.target.set(this.hull.position.x,2,this.hull.position.z);let e=this.camera.position;e.y<2&&(e.y=2),this.orbit.update()}for(let e of this.modeListeners)e(t)}}setFlyDirection(e){let t=e.clone().normalize();this.yaw=Math.atan2(-t.x,-t.z),this.pitch=At.clamp(Math.asin(At.clamp(t.y,-1,1)),-1.4,1.4),this.camera.quaternion.setFromEuler(new ln(this.pitch,this.yaw,0,`YXZ`))}update(e){let t=this.keys;if(this.mode===`orbit`){this.orbit.update();return}if(this.mode===`fly`){let n=(t.has(`shift`)?60:20)*e,r=this.camera.quaternion.setFromEuler(this.tmpEuler.set(this.pitch,this.yaw,0,`YXZ`)),i=this.tmpFwd.set(0,0,-1).applyQuaternion(r),a=this.tmpRight.set(1,0,0).applyQuaternion(r),o=this.camera.position;t.has(`w`)&&o.addScaledVector(i,n),t.has(`s`)&&o.addScaledVector(i,-n),t.has(`d`)&&o.addScaledVector(a,n),t.has(`a`)&&o.addScaledVector(a,-n),t.has(`e`)&&(o.y+=n),t.has(`q`)&&(o.y-=n),o.y<-60&&(o.y=-60);return}let n=this.hull,r=+!!t.has(`w`)-!!t.has(`s`),i=+!!t.has(`a`)-!!t.has(`d`);n.update(e,r,i,this.water),this.lastWaterHeight=this.water.heightAt(n.position.x,n.position.z);let a=n.heading+.5,o=this.tmpFwd.set(Math.sin(a)*62,22,Math.cos(a)*62).add(n.position);o.y=Math.max(o.y,this.lastWaterHeight+10),this.camera.position.lerp(o,Math.min(1,e*2)),this.lookTarget.lerp(this.tmpRight.set(n.position.x,this.lastWaterHeight+8,n.position.z),Math.min(1,e*3)),this.camera.lookAt(this.lookTarget)}},mg=`fft-ocean.lastContextLoss`,hg=8,gg=class{renderer;probeFrames;stage=`boot`;frame=0;mode=`orbit`;lostAt=null;lostFrame=0;gpu;gl;target=new Xt(1,1,{depthBuffer:!1});px=new Uint8Array(4);tmpColor=new Y;buffer=``;dpr=1;constructor(e,t=hg){this.renderer=e,this.probeFrames=t;let n=e.getContext();this.gl=n;let r=n.getExtension(`WEBGL_debug_renderer_info`);this.gpu=String(r&&n.getParameter(r.UNMASKED_RENDERER_WEBGL)||n.getParameter(n.RENDERER)||`unknown GPU`),this.fill()}fill(){let e=this.renderer,t=e.getRenderTarget(),n=e.getClearColor(this.tmpColor).getHex(),r=e.getClearAlpha();e.setRenderTarget(this.target),e.setClearColor(16777215,1),e.clear(!0,!1,!1),e.setClearColor(n,r),e.setRenderTarget(t),this.lostAt=null}modeChanged(e){this.mode=e,this.frame=0}mark(e){this.lostAt===null&&this.frame<this.probeFrames&&this.probe(),this.stage=e}endFrame(e){this.lostAt===null&&this.frame<this.probeFrames&&this.probe();let t=this.gl;t.drawingBufferWidth>0&&(this.buffer=`${t.drawingBufferWidth}×${t.drawingBufferHeight} @${e}`),this.dpr=e,this.frame++}report(e){return{stage:this.lostAt??this.stage,frame:this.lostAt===null?Math.max(0,this.frame-1):this.lostFrame,mode:this.mode,gpu:this.gpu,tier:e,buffer:this.buffer||`? @${this.dpr}`,ua:navigator.userAgent,at:new Date().toISOString()}}probe(){let e=this.gl,t=this.renderer;e.finish();let n=t.getRenderTarget();t.setRenderTarget(this.target),this.px.fill(0),e.readPixels(0,0,1,1,e.RGBA,e.UNSIGNED_BYTE,this.px),t.setRenderTarget(n),this.px[0]!==255&&(this.lostAt=this.stage,this.lostFrame=this.frame)}};function _g(e){try{localStorage.setItem(mg,JSON.stringify(e))}catch{}}function vg(){try{let e=localStorage.getItem(mg);return e?JSON.parse(e):null}catch{return null}}function yg(e){return[`GPU CONTEXT LOST`,`while: ${e.stage} (frame ${e.frame} of ${e.mode} mode)`,`${e.gpu} · ${e.tier} · ${e.buffer}`,e.ua,`After a GPU crash the browser usually blocks WebGL for this site until it is closed completely and reopened.`].join(`
`)}function bg(e){let t=new Date(e.at);return`The previous visit (${Number.isNaN(t.getTime())?e.at:t.toLocaleString()}) lost the GPU while: ${e.stage} (frame ${e.frame} of ${e.mode} mode) on ${e.gpu}, ${e.tier} tier, ${e.buffer}. Browsers block WebGL for a site for a while after a GPU crash; closing the browser completely and reopening it clears that.`}var xg={fairWeather:{label:`Fair Weather`,patch:{waves:{windSpeed:15,peakWavelength:47},foam:{crestStrength:3.2}}},arctic:{label:`Arctic`,patch:{waves:{windSpeed:3,peakWavelength:11},color:{waterColor:`#414449`,absorptionColor:`#050505`,transmissionColor:`#505860`},sky:{timeOfDay:10,cloudCoverage:1},fog:{color:`#c4c0ba`,near:300,far:1200}}},corsair:{label:`Corsair`,patch:{waves:{windSpeed:15,peakWavelength:47},foam:{crestStrength:3.2},color:{waterColor:`#0b2a33`},sky:{timeOfDay:14,cloudCoverage:.5}}},dusk:{label:`Dusk`,patch:{waves:{windSpeed:7,peakWavelength:140},sky:{timeOfDay:18.5,cloudCoverage:.3},color:{waterColor:`#2c3a50`},fog:{color:`#403c52`}}},foggy:{label:`Foggy`,patch:{waves:{windSpeed:5,peakWavelength:110},fog:{color:`#5a544d`,near:20,far:260},color:{waterColor:`#5a5147`,absorptionColor:`#050505`,transmissionColor:`#55504a`},sky:{timeOfDay:8,cloudCoverage:1},weather:{rain:.25}}},moonlit:{label:`Moonlit`,patch:{waves:{windSpeed:3,peakWavelength:80},sky:{timeOfDay:0,cloudCoverage:.2},color:{waterColor:`#04101c`}}},tropics:{label:`Tropics`,patch:{waves:{windSpeed:10.2,peakWavelength:130},color:{waterColor:`#1a5068`,transmissionColor:`#6fd0b0`},sky:{timeOfDay:13}}},storm:{label:`Storm`,patch:{waves:{windSpeed:17,peakWavelength:60},foam:{threshold:.85,crestStrength:3.5,decayTime:.8},sky:{timeOfDay:18.2,cloudCoverage:1},color:{waterColor:`#67707a`,absorptionColor:`#050505`,transmissionColor:`#565a5c`},sun:{intensity:.8},fog:{color:`#504c48`,near:40,far:700},weather:{rain:.9}}},sunset:{label:`Sunset`,patch:{waves:{windSpeed:2.5,peakWavelength:20},sky:{timeOfDay:18.4,cloudCoverage:.35},color:{waterColor:`#1c2c42`},fog:{color:`#454c5c`}}}};Object.keys(xg);var Sg=`fairWeather`;function Cg(e,t){let n=Ou(e);for(let e of Object.keys(t)){let r=t[e];r&&typeof r==`object`?Object.assign(n[e],r):r!==void 0&&(n[e]=r)}return n}function wg(e,t){let n=xg[e];if(!n)throw Error(`unknown preset: ${e}`);let r=Cg(Tu,n.patch);return r.quality=t.quality,r}function Tg(e,t,n){let r=Ou(e),i=t.split(`.`),a=r;for(let e=0;e<i.length-1;e++){let t=i[e],n=a[t];if(!n||typeof n!=`object`)throw Error(`setPath: no object at ${i.slice(0,e+1).join(`.`)}`);a=n}return a[i[i.length-1]]=n,r}function Eg(e,t){let n=e;for(let e of t.split(`.`)){if(!n||typeof n!=`object`)return;n=n[e]}return n}var Dg=[{value:`low`,label:`Low`},{value:`medium`,label:`Medium`},{value:`high`,label:`High`},{value:`ultra`,label:`Ultra`},{value:`max`,label:`Max`}],Og=[{id:`windSpeed`,path:`waves.windSpeed`,label:`Wind Speed`,min:.1,max:25,step:.1,format:e=>`${e.toFixed(1)} m/s`},{id:`peakWavelength`,path:`waves.peakWavelength`,label:`Peak Wavelength`,min:1,max:200,step:1,format:e=>`${Math.round(e)} m`},{id:`timeOfDay`,path:`sky.timeOfDay`,label:`Time of Day`,min:0,max:24,step:.25,format:kg},{id:`cloudCoverage`,path:`sky.cloudCoverage`,label:`Cloud Coverage`,min:0,max:1,step:.01,format:e=>`${Math.round(e*100)}%`},{id:`sprayDensity`,path:`spray.density`,label:`Spray Density`,min:0,max:2,step:.05,format:e=>`${e.toFixed(2)}×`},{id:`rainAmount`,path:`weather.rain`,label:`Rain`,min:0,max:1,step:.01,format:e=>`${Math.round(e*100)}%`}];function kg(e){let t=Math.floor(e)%24,n=Math.round((e-Math.floor(e))*60);return`${String(t).padStart(2,`0`)}:${String(n).padStart(2,`0`)}`}var Ag=class{el;listeners=[];sliders=new Map;quality;preset;pixelRatio;pixelRatioValue;pill;ssr;sunShafts;spray;rain;constructor(e,t,n,r){this.el=document.createElement(`aside`),this.el.className=`panel`,this.el.dataset.testid=`panel`,this.el.innerHTML=`
      ...
      </footer>`,e.appendChild(this.el),this.pill=this.el.querySelector(`.pill`),this.quality=this.el.querySelector(`[data-testid="quality"]`);for(let e of Dg){let t=document.createElement(`option`);t.value=e.value,t.textContent=e.label,this.quality.appendChild(t)}this.quality.value=t.quality,this.quality.addEventListener(`change`,()=>this.emit({kind:`quality`,tier:this.quality.value})),this.preset=this.el.querySelector(`[data-testid="preset"]`);for(let[e,t]of Object.entries(xg)){let n=document.createElement(`option`);n.value=e,n.textContent=t.label,this.preset.appendChild(n)}this.preset.value=n,this.preset.addEventListener(`change`,()=>this.emit({kind:`preset`,name:this.preset.value}));let i=this.el.querySelector(`.sliders`);for(let e of Og){let t=document.createElement(`div`);t.className=`field slider-field`,t.innerHTML=`
        <div class="row"><span class="label">${e.label}</span><span class="value" data-testid="${e.id}-value"></span></div>
        <input type="range" data-testid="${e.id}" min="${e.min}" max="${e.max}" step="${e.step}" />`,i.appendChild(t);let n=t.querySelector(`input`),r=t.querySelector(`.value`);this.sliders.set(e.id,{input:n,value:r,def:e}),n.addEventListener(`input`,()=>{let t=Number(n.value);this.paintSlider(n,r,e,t),this.emit({kind:`param`,path:e.path,value:t})})}this.pixelRatio=this.el.querySelector(`[data-testid="pixelRatio"]`),this.pixelRatioValue=this.el.querySelector(`[data-testid="pixelRatio-value"]`),this.pixelRatio.value=String(r),this.paintRange(this.pixelRatio),this.pixelRatioValue.textContent=`${r.toFixed(2)}×`,this.pixelRatio.addEventListener(`input`,()=>{let e=Number(this.pixelRatio.value);this.paintRange(this.pixelRatio),this.pixelRatioValue.textContent=`${e.toFixed(2)}×`,this.emit({kind:`pixelRatio`,value:e})});for(let e of[`buoyancyProbes`,`wakeProbes`]){let t=this.el.querySelector(`[data-testid="${e}"]`);t.addEventListener(`change`,()=>this.emit({kind:`toggle`,id:e,value:t.checked}))}this.sunShafts=this.el.querySelector(`[data-testid="sunShafts"]`),this.sunShafts.addEventListener(`change`,()=>this.emit({kind:`sunShafts`,value:this.sunShafts.checked})),this.ssr=this.el.querySelector(`[data-testid="ssr"]`),this.ssr.addEventListener(`change`,()=>this.emit({kind:`param`,path:`fresnel.ssr`,value:this.ssr.checked})),this.spray=this.el.querySelector(`[data-testid="spray"]`),this.spray.addEventListener(`change`,()=>this.emit({kind:`param`,path:`spray.enabled`,value:this.spray.checked})),this.rain=this.el.querySelector(`[data-testid="rain"]`),this.rain.addEventListener(`change`,()=>this.emit({kind:`param`,path:`weather.rainEnabled`,value:this.rain.checked})),this.sync(t)}onChange(e){this.listeners.push(e)}sync(e){this.quality.value=e.quality,this.ssr.checked=e.fresnel.ssr,this.ssr.disabled=!Du(e.quality).ssr,this.sunShafts.checked=e.underwater.sunShafts,this.spray.checked=e.spray.enabled,this.spray.disabled=!Du(e.quality).spray,this.rain.checked=e.weather.rainEnabled,this.rain.disabled=!Du(e.quality).rain;for(let{input:t,value:n,def:r}of this.sliders.values()){let i=jg(e,r.path);t.value=String(i),this.paintSlider(t,n,r,i)}}setPreset(e){this.preset.value=e}setPixelRatio(e){this.pixelRatio.value=String(e),this.paintRange(this.pixelRatio),this.pixelRatioValue.textContent=`${e.toFixed(2)}×`}setRebuilding(e){this.pill.hidden=!e,this.quality.disabled=e}paintSlider(e,t,n,r){t.textContent=n.format(r),this.paintRange(e)}paintRange(e){let t=Number(e.min),n=Number(e.max),r=(Number(e.value)-t)/(n-t)*100;e.style.setProperty(`--fill`,`${r}%`)}emit(e){for(let t of this.listeners)t(e)}};function jg(e,t){let n=e;for(let e of t.split(`.`))n=n[e];return typeof n==`number`?n:0}var Mg=[`spectrum`,`fft`,`unpack`,`prepass`,`water`,`spray`,`rain`,`wake`,`post`],Ng=class{el;fields={};gpuLine;bigFps;frames=0;accumMs=0;lastFlush=performance.now();lastStats={fps:0,frameMs:0,draws:0,tris:0,dpr:1,gpu:{supported:!1,sections:{},total:0,floor:0}};draws=0;tris=0;gpu=null;gpuFloor=0;constructor(e,t,n,r=!1){this.bigFps=t,this.el=document.createElement(`div`),this.el.className=`hud`,this.el.dataset.testid=`hud`;let i=document.createElement(`div`);i.className=`hud-line`,[[`gpu`,n],[`fps`,`FPS —`],[`frame`,`Frame — ms`],[`draws`,`Draws —`],[`tris`,`Tris —`],[`dpr`,`DPR —`]].forEach(([e,t],n)=>{if(n>0){let e=document.createElement(`span`);e.className=`hud-sep`,e.textContent=`·`,i.appendChild(e)}let r=document.createElement(`span`);r.dataset.testid=`hud-${e}`,r.textContent=t,i.appendChild(r),this.fields[e]=r}),this.el.appendChild(i),this.gpuLine=document.createElement(`div`),this.gpuLine.className=`hud-line hud-gpu`,this.gpuLine.dataset.testid=`hud-gpu-sections`,this.gpuTimerSupported=r,this.el.appendChild(this.gpuLine),this.lastStats.gpu.supported=r,e.appendChild(this.el),this.render()}gpuTimerSupported;frame(e,t,n,r,i=null,a=0){this.frames++,this.accumMs+=e,this.draws=t,this.tris=n,this.gpu=i,this.gpuFloor=a;let o=performance.now(),s=o-this.lastFlush;if(s>=250){let e=this.frames*1e3/s;this.lastStats={fps:e,frameMs:this.accumMs/this.frames,draws:t,tris:n,dpr:r,gpu:this.gpuStats()},this.frames=0,this.accumMs=0,this.lastFlush=o,this.render()}}setGpuLabel(e){this.fields.gpu.textContent=e}stats(){return{...this.lastStats,draws:this.draws,tris:this.tris,gpu:this.gpuStats()}}gpuStats(){if(!this.gpu)return{supported:!1,sections:{},total:0,floor:0};let e={...this.gpu},t=0;for(let n of Object.keys(e))t+=e[n];return{supported:!0,sections:e,total:t,floor:this.gpuFloor}}render(){let e=this.lastStats;if(this.fields.fps.textContent=`FPS ${e.fps.toFixed(0)}`,this.fields.frame.textContent=`Frame ${e.frameMs.toFixed(1)} ms`,this.fields.draws.textContent=`Draws ${e.draws}`,this.fields.tris.textContent=`Tris ${Fg(e.tris)}`,this.fields.dpr.textContent=`DPR ${e.dpr.toFixed(2)}`,!this.gpuTimerSupported)this.gpuLine.textContent=`GPU ms n/a (no EXT_disjoint_timer_query_webgl2)`;else if(!this.gpu)this.gpuLine.textContent=`GPU ms off`;else if(Object.keys(e.gpu.sections).length===0)this.gpuLine.textContent=`GPU ms —`;else{let t=Pg(e.gpu.sections).map(t=>`${t} ${e.gpu.sections[t].toFixed(2)}`),n=e.gpu.floor>.05?` · floor ${e.gpu.floor.toFixed(2)}`:``;this.gpuLine.textContent=`GPU ms ${e.gpu.total.toFixed(2)} · ${t.join(` · `)}${n}`}this.bigFps&&(this.bigFps.textContent=e.fps.toFixed(0))}};function Pg(e){let t=Object.keys(e),n=Mg.filter(e=>t.includes(e));for(let e of t)n.includes(e)||n.push(e);return n}function Fg(e){return e>=1e6?`${(e/1e6).toFixed(2)}M`:e>=1e3?`${(e/1e3).toFixed(1)}k`:`${e}`}var Ig=[`LOADING MODELS & WATER`,`LOADING ENVIRONMENT`,`GENERATING SKY`,`COMPILING SHADERS`,`READY`],Lg=class{el;message;bar;log;stage=-1;constructor(e){this.el=document.createElement(`div`),this.el.className=`loading`,this.el.dataset.testid=`loading`,this.el.innerHTML=`
      ...
      <ol class="loading-log" data-testid="loading-log"></ol>`,e.appendChild(this.el),this.message=this.el.querySelector(`.loading-message`),this.bar=this.el.querySelector(`.loading-fill`),this.log=this.el.querySelector(`.loading-log`)}async next(){if(this.el.dataset.state===`lost`)return;this.stage=Math.min(this.stage+1,Ig.length-1);let e=Ig[this.stage];this.message.textContent=e;let t=document.createElement(`li`);t.textContent=e,this.log.appendChild(t),this.bar.style.width=`${(this.stage+1)/Ig.length*100}%`,await Rg(),await Rg()}fail(e){this.message.textContent=e,this.el.dataset.state=`failed`,this.el.classList.add(`is-failed`),this.bar.style.width=`0`}lost(e){this.el.hidden=!1,this.el.classList.remove(`is-done`),this.fail(e),this.el.dataset.state=`lost`}recovered(){this.el.dataset.state===`lost`&&(delete this.el.dataset.state,this.el.classList.remove(`is-failed`),this.el.classList.add(`is-done`),this.el.hidden=!0)}async finish(){for(;this.stage<Ig.length-1&&this.el.dataset.state!==`lost`;)await this.next();await zg(250),this.el.dataset.state!==`lost`&&(this.el.classList.add(`is-done`),await zg(450),this.el.dataset.state!==`lost`&&(this.el.hidden=!0))}};function Rg(){return new Promise(e=>requestAnimationFrame(()=>e()))}function zg(e){return new Promise(t=>setTimeout(t,e))}var Bg=class extends Error{};function Vg(e){if(!e.capabilities.isWebGL2)throw new Bg(`This demo needs WebGL2.`);if(!e.extensions.has(`EXT_color_buffer_float`))throw new Bg(`This demo needs WebGL2 with float render targets (EXT_color_buffer_float), which this GPU or browser does not provide.`)}async function Hg(e){let t=document.getElementById(`app`),n=document.getElementById(`ui`);await e.next();let r=new URLSearchParams(location.search),i,a=document.createElement(`canvas`),o=``;a.addEventListener(`webglcontextcreationerror`,e=>{o=e.statusMessage});try{i=new wu({canvas:a,antialias:!0,powerPreference:`high-performance`})}catch(e){let t=vg();throw new Bg([`This demo needs WebGL2, which this browser could not create.`,o||String(e),t?bg(t):``].filter(Boolean).join(`

`))}Vg(i);let s=new gg(i,r.get(`diag`)===`1`?1/0:void 0);i.outputColorSpace=ze,i.toneMapping=4,i.toneMappingExposure=1;let c=Math.min(window.devicePixelRatio||1,2);i.setPixelRatio(c),i.setSize(window.innerWidth,window.innerHeight),i.domElement.id=`canvas`,t.insertBefore(i.domElement,e.el);let l=wg(Sg,Tu),u=Sg,d=new Fn,f=new Mu(i);f.enabled=r.get(`gpuTimer`)===`1`;let p=new pf(i,l,{timer:f});if(d.add(p),!Pu(p.sim))throw Error(`simulation has no height readback (buoyancy)`);let m=p.sim;await Rg(),await e.next();let h=new bm(m),g=new bm(m,{slotBase:1e3}),_=new pg(i.domElement,window.innerWidth/window.innerHeight,h);d.add(_.hull,_.hull.probes);let v=new jh(i);d.add(v.debug);let y=new Xm(i);d.add(y.points);let b=new Rm(i);d.add(b.mesh),_.onModeChange(e=>{s.modeChanged(e),e!==`boat`&&(v.reset(),p.material.setWake(null)),y.reset(),b.reset()});let x=new No(16777215,2.5),S=new mo(12572927,2375770,.8);d.add(x,S),i.shadowMap.enabled=!0,i.shadowMap.type=1,i.shadowMap.autoUpdate=!1,x.castShadow=!0,x.shadow.mapSize.set(1024,1024),x.shadow.camera.left=x.shadow.camera.bottom=-70,x.shadow.camera.right=x.shadow.camera.top=70,x.shadow.camera.near=1,x.shadow.camera.far=400,x.shadow.bias=-5e-4,x.shadow.normalBias=.05,i.shadowMap.needsUpdate=!0;let C=new Pf;d.add(C.mesh);let w=new Af(i),T=new Tf(l.waves.seed);T.setParams(l),T.attachTo(p),d.add(T);let E=new pm(l.waves.seed,{islandPosition:T.position,...new URLSearchParams(location.search).get(`palms`)===`procedural`?{}:{loader:Hp()}});d.add(E);let D=!1,O=!1,k=new Dn;k.visible=!1;let A=new ha(.25,8,6),j=new Jr({color:16733491});for(let e=0;e<25;e++)k.add(new oi(A,j));d.add(k),await Rg(),await e.next(),p.sky.update(l.sky.timeOfDay,l.sky.cloudCoverage,l.fog),await Rg(),await e.next(),p.update(_.camera,0,0),i.compile(d,_.camera),i.render(d,_.camera),await Rg();let M=new Ng(n,Kg(n,_).fps,`GPU WebGL2`,f.supported),ee=new Ag(n,l,u,c),N=0,te=!1,P=e=>{l=e,p.setParams(l),T.setParams(l),ee.sync(l)},ne=async(e,t=!1)=>{if(te)return;te=!0,t&&(p.contextRestored(),v.reset(),p.material.setWake(null),f.reset(),s.fill()),ee.setRebuilding(!0),await Rg(),await Rg();let n=Ou(l);n.quality=e,P(n),y.reset(),b.reset(),p.update(_.camera,N,0),i.compile(d,_.camera),await xe(),ee.setRebuilding(!1),te=!1},F=e=>ne(e),re=!1;i.domElement.addEventListener(`webglcontextlost`,t=>{t.preventDefault(),re=!0,M.setGpuLabel(`GPU context lost`);let n=s.report(l.quality);_g(n),console.warn(`WebGL context lost while: ${n.stage} (frame ${n.frame} of ${n.mode} mode) on ${n.gpu}`),e.lost(yg(n))}),i.domElement.addEventListener(`webglcontextrestored`,()=>{ne(l.quality,!0).then(()=>{re=!1,M.setGpuLabel(`GPU WebGL2`),e.recovered()})});let ie=e=>(u=e,ee.setPreset(e),P(wg(e,l)),xe());ee.onChange(e=>{switch(e.kind){case`quality`:F(e.tier);break;case`preset`:ie(e.name);break;case`param`:P(Tg(l,e.path,e.value));break;case`pixelRatio`:c=e.value,i.setPixelRatio(c),i.setSize(window.innerWidth,window.innerHeight);break;case`toggle`:e.id===`buoyancyProbes`?O=e.value:e.id===`wakeProbes`&&(v.debug.visible=e.value);break;case`sunShafts`:P(Tg(l,`underwater.sunShafts`,e.value))}}),window.addEventListener(`keydown`,e=>{let t=e.target;(!t||t.tagName!==`INPUT`&&t.tagName!==`SELECT`)&&(e.key===`h`||e.key===`H`)&&n.classList.toggle(`is-hidden`)}),window.addEventListener(`resize`,()=>{i.setSize(window.innerWidth,window.innerHeight),_.camera.aspect=window.innerWidth/window.innerHeight,_.camera.updateProjectionMatrix()});let ae=performance.now(),oe=[],se=null,I=null,ce=null,le=new Map,ue=new G,de=new Y,fe={sky:new Y,ground:new Y},pe={samples:[],heading:0,speed:0},me={dt:0,params:l,cascades:m.cascades,camera:_.camera,sky:p.sky,bow:null,hidden:!1,bufferHeight:0},he={dt:0,t:0,params:l,camera:_.camera,sky:p.sky,hidden:!1,bufferHeight:0},ge=e=>{if(re&&!te){let e=oe;oe=[];for(let t of e)t();return}N+=e;let t=performance.now();f.poll();let n=_.mode===`boat`;k.visible=O&&!n,_.hull.probes.visible=O&&n;let r=n?_.hull.position:_.camera.position;if((n||k.visible)&&(s.mark(`hull height readback`),h.update(r.x,r.z,n?_.hull.physics.footprintRadius:0)),_.update(e),s.mark(`ocean simulation`),p.update(_.camera,N,e),_.mode===`boat`){let t=_.hull;s.mark(`wake simulation`),f.begin(`wake`),v.update(e,{x:t.position.x,z:t.position.z,heading:t.heading,speed:t.speed,length:t.length,beam:t.beam},t.position.y),f.end();let[n,r]=v.origin;p.material.setWake(v.texture,n,r,v.size)}if(k.visible){let e=0;for(let t=-2;t<=2;t++)for(let n=-2;n<=2;n++){let i=r.x+n*3,a=r.z+t*3;k.children[e++].position.set(i,h.heightAt(i,a),a)}}let a=_.camera.position,o=0;a.y<12?(s.mark(`camera height readback`),g.update(a.x,a.z),o=((n||k.visible)&&h.covers(a.x,a.z)?h:g).heightAt(a.x,a.z)-a.y,D=o>0):D=!1,p.material.setUnderwater(D),s.mark(`spray`),f.begin(`spray`),me.dt=e,me.params=l,me.cascades=m.cascades,me.hidden=D,me.bufferHeight=i.getContext().drawingBufferHeight,n?(pe.samples=_.hull.samples,pe.heading=_.hull.heading,pe.speed=_.hull.speed,me.bow=pe):me.bow=null,y.update(me),f.end(),s.mark(`rain`),f.begin(`rain`),he.dt=e,he.t=N,he.params=l,he.hidden=D,he.bufferHeight=me.bufferHeight,b.update(he);let[u,A]=b.fieldOrigin;p.material.setRain(b.intensity>0?b.ripple.texture:null,u,A,b.fieldSize,b.intensity),f.end(),s.mark(`underwater, island, lights`),p.sky.skybox.visible=!D,C.visible=D,D&&C.update(_.camera,l,p.sky,N),_.camera.updateMatrixWorld(),D?w.update(_.camera,p.sky,l,o,C.caustics,N):w.strength=0,T.update(p.sky,N,D),E.update(N,l.waves.windDirection,l.waves.windSpeed),x.position.copy(p.sky.sunDirection).multiplyScalar(100).add(_.camera.position),x.target.position.copy(_.camera.position),x.target.updateMatrixWorld(),n&&(i.shadowMap.needsUpdate=!0);let j=p.sky.sunDirection.y;x.intensity=.4+2.2*Math.max(0,j),S.intensity=.3+1.2*Math.max(0,ue.copy(p.sky.sunDirection).y),p.sky.sunColor(x.color).lerp(de.setRGB(.55,.65,.9),1-Ug(-.2,.05,j));let ee=p.sky.ambient(fe);S.color.copy(ee.sky).multiplyScalar(2.2).lerp(de.setRGB(.8,.85,.95),.35),S.groundColor.copy(ee.ground).multiplyScalar(4);let P=1-Ug(-.32,-.08,j);if(i.toneMappingExposure=1+.25*P,s.mark(`scene depth pre-pass`),p.renderSceneDepth(d,_.camera),w.active?(s.mark(`sun shafts + scene render`),w.render(d,_.camera,f)):(s.mark(n?`shadow map + scene render`:`scene render`),f.begin(`water`),i.render(d,_.camera),f.end()),s.endFrame(c),se&&=(le.set(se,Wg(i)),null),I){let e=i.getContext(),t=new Uint8Array(4),n=Math.floor(I.u*(e.drawingBufferWidth-1)),r=Math.floor((1-I.v)*(e.drawingBufferHeight-1));e.readPixels(n,r,1,1,e.RGBA,e.UNSIGNED_BYTE,t),I.resolve([t[0],t[1],t[2],t[3]]),I=null}if(ce){let e=i.getContext(),t=e.drawingBufferHeight,n=new Uint8Array(t*4),r=Math.floor(ce.u*(e.drawingBufferWidth-1));e.readPixels(r,0,1,t,e.RGBA,e.UNSIGNED_BYTE,n);let a=Array(t);for(let e=0;e<t;e++){let r=(t-1-e)*4;a[e]=.2126*n[r]+.7152*n[r+1]+.0722*n[r+2]}ce.resolve(a),ce=null}let ne=i.info.render;M.frame(performance.now()-t,ne.calls,ne.triangles,c,f.smoothed(),f.floor());let F=oe;oe=[];for(let e of F)e()},_e=!1,ve=!1,ye=e=>{if(ve=!1,_e)return;let t=Math.min(.1,Math.max(0,(e-ae)/1e3));ae=e,ge(t),be()},be=()=>{ve||(ve=!0,requestAnimationFrame(ye))},xe=()=>new Promise(e=>oe.push(e)),Se=(e,t=1)=>{if(_e)return Promise.reject(Error(`step: already driving`));if(!(e>0)||!(t>=0))return Promise.reject(Error(`step: dt must be > 0 and frames ≥ 0`));_e=!0;try{for(let n=0;n<t;n++)ge(e)}finally{_e=!1,ae=performance.now(),be()}return Promise.resolve()},Ce=(e,t=1/60)=>Se(t,Math.round(e/t));be(),await xe(),await e.finish();let we=(async()=>{if(await E.ready,Wp()===`gltf`)try{let e=await Up(Bp,gm(),{targetLength:_.hull.length,targetDraft:_.hull.physics.dims.draft});_.hull.setModel(e.model,e.dims,`gltf`,e.dispose),i.compile(d,_.camera)}catch(e){console.warn(`ship glTF unavailable, keeping the procedural galleon: ${String(e)}`)}})();window.__app={...window.__app,params:()=>Ou(l),setParam:(e,t)=>{let n=typeof Eg(l,e)==`number`&&typeof t==`string`?Number(t):t;return P(Tg(l,e,n)),xe()},setPreset:ie,setQuality:F,setMode:e=>(_.setMode(e),xe()),frame:xe,step:Se,advance:Ce,simTime:()=>N,stats:()=>M.stats(),setGpuTimer:e=>(f.enabled=e,xe()),contextLost:()=>re,gpuWatch:()=>({stage:s.stage,frame:s.frame,mode:s.mode,lostAt:s.lostAt,gpu:s.gpu}),camera:()=>({position:_.camera.position.toArray(),mode:_.mode}),setCameraPosition:e=>(_.setMode(`fly`),_.camera.position.set(e[0],e[1],e[2]),xe()),underwater:()=>D,setCameraDirection:e=>(_.setMode(`fly`),_.setFlyDirection(new G(e[0],e[1],e[2])),xe()),sunShafts:()=>({sunUv:[w.sunUv.x,1-w.sunUv.y],strength:w.strength,sunDir:w.sunDirW.toArray()}),spray:()=>({...y.count(),capacity:y.capacity}),rain:()=>({streaks:b.streaks,ripples:b.ripples,intensity:b.intensity}),hull:()=>({position:_.hull.position.toArray(),waterHeight:_.lastWaterHeight}),ship:()=>({speed:_.hull.speed,pitch:_.hull.pitch,roll:_.hull.roll,heading:_.hull.heading,model:_.hull.modelKind}),assetsReady:we,vegetation:()=>({palms:E.palmCount,rocks:E.rockCount,model:E.palmModel}),snapshot:e=>(se=e,xe()),diff:(e,t)=>{let n=le.get(e),r=le.get(t);if(!n||!r||n.length!==r.length)throw Error(`diff: missing or mismatched snapshots`);let i=0;for(let e=0;e<n.length;e+=4)i+=Math.abs(n[e]-r[e]),i+=Math.abs(n[e+1]-r[e+1]),i+=Math.abs(n[e+2]-r[e+2]);return i/(n.length/4*3)},pixel:(e,t)=>new Promise(n=>I={u:e,v:t,resolve:n}),column:e=>new Promise(t=>ce={u:e,resolve:t}),preset:()=>u,wakeSample:(e,t)=>v.sample(e,t)}}function Ug(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}function Wg(e){let t=e.getContext(),n=t.drawingBufferWidth,r=t.drawingBufferHeight,i=new Uint8Array(n*r*4);return t.readPixels(0,0,n,r,t.RGBA,t.UNSIGNED_BYTE,i),i}var Gg={orbit:[[`Orbit`,`LMB`],[`Pan`,`RMB`],[`Zoom`,`Scroll`]],fly:[[`Move`,`WASD`],[`Up / Down`,`E / Q`],[`Look`,`Drag`]],boat:[[`Throttle`,`W / S`],[`Rudder`,`A / D`],[`Hide UI`,`H`]]};function Kg(e,t){let n=document.createElement(`div`);n.className=`card`,n.dataset.testid=`mode-card`,n.innerHTML=`
    <div class="fps"><div class="fps-num" data-testid="fps-big">—</div><div class="fps-label">FPS</div></div>
    <div class="modes"></div>
    <dl class="legend" data-testid="legend"></dl>`,e.appendChild(n);let r=n.querySelector(`.modes`),i=n.querySelector(`.legend`),a=new Map;for(let e of[`orbit`,`fly`,`boat`]){let n=document.createElement(`button`);n.type=`button`,n.className=`mode`,n.dataset.testid=`mode-${e}`,n.innerHTML=`<span class="mode-key">${ug[e]}</span><span class="mode-name">${e[0].toUpperCase()}${e.slice(1)}</span>`,n.addEventListener(`click`,()=>t.setMode(e)),r.appendChild(n),a.set(e,n)}let o=e=>{for(let[t,n]of a)n.classList.toggle(`is-active`,t===e);i.innerHTML=Gg[e].map(([e,t])=>`<div class="legend-row"><dt>${e}</dt><dd><kbd>${t}</kbd></dd></div>`).join(``)};return o(t.mode),t.onModeChange(o),{fps:n.querySelector(`.fps-num`)}}var qg=new Lg(document.getElementById(`app`)),Jg=Hg(qg);window.__app={ready:Jg},Jg.catch(e=>{e instanceof Bg?(console.warn(e.message),qg.fail(e.message)):(console.error(e),qg.fail(`FAILED: ${String(e)}`))});